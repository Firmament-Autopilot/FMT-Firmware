...
#define USE_FPU /* ARMCC */ ((defined(__CC_ARM) && defined(__TARGET_FPU_VFP)) /* IAR */ || (defined(__ICCARM__) && defined(__ARMVFP__)) /* GNU */ || (defined(__GNUC__) && defined(__VFP_FP__) && !defined(__SOFTFP__)))
...
#ifdef FMT_USING_CM_BACKTRACE
    cm_backtrace_fault(exception_stack->lr, cmb_get_sp());
#endif
