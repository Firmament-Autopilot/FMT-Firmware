...
RT_WEAK void bmi088_rotate_to_ned(float val[3])
{
    /* do nothing */
}
...
static rt_err_t accel_set_bwp_odr(uint16_t frequency_hz)
{
    ...
    if (frequency_hz <= (125 / 10)) {
        reg_val = BMI088_ACCEL_BW_12_5;
    } else if (frequency_hz <= 25) {
        reg_val = BMI088_ACCEL_BW_25;
    } else if (frequency_hz <= 50) {
        reg_val = BMI088_ACCEL_BW_50;
    } else if (frequency_hz <= 100) {
        reg_val = BMI088_ACCEL_BW_100;
    } else if (frequency_hz <= 200) {
        reg_val = BMI088_ACCEL_BW_200;
    } else if (frequency_hz <= 400) {
        reg_val = BMI088_ACCEL_BW_400;
    } else if (frequency_hz <= 800) {
        reg_val = BMI088_ACCEL_BW_800;
    } else if (frequency_hz <= 1600) {
        reg_val = BMI088_ACCEL_BW_1600;
    } else {
        return -EINVAL;
    }
