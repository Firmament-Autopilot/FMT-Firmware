...
static void handle_log_request_list(mavlink_message_t* msg, mavlink_system_t this_system, uint8_t chan)
{
...
static void handle_log_request_data(mavlink_message_t* msg, mavlink_system_t this_system, uint8_t chan)
{
...
static void handle_log_erase(mavlink_message_t* msg, mavlink_system_t this_system)
{
...
static void handle_log_request_end(mavlink_message_t* msg, mavlink_system_t this_system)
{
