...
const ConstB_FMS_T FMS_ConstB = {
  1.9966471893352524,                  /* '<S130>/Sum' */
  0.0066943799901413165,               /* '<S130>/Multiply3' */
  0.99330562000985867,                 /* '<S130>/Sum4' */

  { 0.0F, 0.0F, 1.0F },                /* '<S101>/Vector Concatenate3' */

  { 0.0F, 0.0F, 1.0F },                /* '<S103>/Vector Concatenate3' */
  ...
  6U,                                  /* '<S66>/Data Type Conversion2' */
  3U,                                  /* '<S106>/Data Type Conversion' */
  6U,                                  /* '<S106>/Data Type Conversion1' */
  5U,                                  /* '<S106>/Data Type Conversion2' */
  3U,                                  /* '<S107>/Data Type Conversion' */
  16U,                                 /* '<S107>/Data Type Conversion1' */
  5U,                                  /* '<S107>/Data Type Conversion2' */
  ...
  {
    1U,                                /* '<S108>/Data Type Conversion' */
    1U                                 /* '<S108>/Data Type Conversion1' */
  }
  /* End of '<S29>/Unknown' */
};
