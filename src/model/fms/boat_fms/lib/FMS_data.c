...
const ConstB_FMS_T FMS_ConstB = {
  1.9966471893352524,                  /* '<S154>/Sum' */
  0.0066943799901413165,               /* '<S154>/Multiply3' */
  0.99330562000985867,                 /* '<S154>/Sum4' */
  ...
  3U,                                  /* '<S128>/Data Type Conversion' */
  6U,                                  /* '<S128>/Data Type Conversion1' */
  5U,                                  /* '<S128>/Data Type Conversion2' */
  3U,                                  /* '<S129>/Data Type Conversion' */
  16U,                                 /* '<S129>/Data Type Conversion1' */
  5U,                                  /* '<S129>/Data Type Conversion2' */
