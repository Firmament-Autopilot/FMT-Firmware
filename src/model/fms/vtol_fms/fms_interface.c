...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(XY_P, 1.2),
    PARAM_FLOAT(Z_P, 1.5),
    PARAM_FLOAT(VEL_XY_LIM, 5.0),
    PARAM_FLOAT(VEL_Z_LIM, 2.0),
    PARAM_FLOAT(YAW_P, 2.5),
    PARAM_FLOAT(YAW_RATE_LIM, PI / 3),
    PARAM_FLOAT(ROLL_PITCH_LIM, PI / 6),
    PARAM_FLOAT(L1, 15.0),
    PARAM_FLOAT(MC_ACCEPT_R, 1.0),
    PARAM_FLOAT(CRUISE_SPEED, 5.0),
    PARAM_FLOAT(CRUISE_ACC, 5.0),
    PARAM_FLOAT(TAKEOFF_H, 2.0),
    PARAM_FLOAT(TAKEOFF_SPEED, 1.0),
    PARAM_FLOAT(ASSIST_LAND_H, 0.5),
    PARAM_FLOAT(LAND_SPEED, 0.6),
    PARAM_UINT16(LOST_RETURN_TIME, 120),
    PARAM_UINT8(LOST_RETURN_EN, 1),
    PARAM_UINT16(LAND_LOCK_THRO, 1300),
    PARAM_FLOAT(FW_L1, 50.0),
    PARAM_FLOAT(FW_CRUISE_SPEED, 18.0),
    PARAM_FLOAT(FW_SPEED_MAX, 22.0),
    PARAM_FLOAT(FW_SPEED_MIN, 14.0),
    PARAM_FLOAT(FW_STALL_SPEED, 10.0),
    PARAM_FLOAT(FW_Z_P, 1.0),
    PARAM_FLOAT(FW_VEL_Z_LIM, 10.0),
    PARAM_FLOAT(FW_ACC_Y_LIM, 8.0),
    PARAM_FLOAT(FW_ROLL_LIM, PI / 4),
    PARAM_FLOAT(FW_PITCH_LIM, PI / 6),
    PARAM_FLOAT(FW_YAW_RATE_LIM, PI / 6),
    PARAM_FLOAT(FW_LOITER_R, 50.0),
    PARAM_FLOAT(FW_ACCEPT_R, 100.0),
};
