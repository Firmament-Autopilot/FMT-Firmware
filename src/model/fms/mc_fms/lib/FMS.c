     ...
     case 0:
      ...
      switch (FMS_DW.SwitchCase_ActiveSubsystem_at) {
       case 0:
        ...
        /* Sum: '<S478>/Add4' */
        rtb_Divide_lr_idx_1 = (rtb_Saturation_n - rtb_a_l) + rtb_Add3_c;
         ...
         *  Sum: '<S478>/Subtract2'
         */
        rtb_a_l += (rtb_Add3_c - rtb_Saturation_n) * 0.5F * rtb_Divide_lr_idx_1;
       ...
       case 2:
         ...
         *  Sum: '<S401>/Subtract'
         */
        rtb_Saturation_n = (FMS_DW.Integrator1_DSTATE_e - rtb_Saturation_n) +
          rtb_Add3_c;
     ...
     case 1:
      ...
      switch (FMS_DW.SwitchCase_ActiveSubsystem_i) {
       case 0:
        ...
        switch (FMS_U.Auto_Cmd.frame) {
         case 0:
           ...
           *  S-Function (sfix_bitop): '<S301>/lat_cmd valid'
           *  S-Function (sfix_bitop): '<S301>/x_cmd valid'
           *  SignalConversion: '<S31>/Signal Copy1'
           *  Sum: '<S302>/Sum1'
           */
           ...
           *  RelationalOperator: '<S309>/Compare'
           *  RelationalOperator: '<S310>/Compare'
           *  S-Function (sfix_bitop): '<S301>/lon_cmd valid'
           *  S-Function (sfix_bitop): '<S301>/y_cmd valid'
           *  SignalConversion: '<S31>/Signal Copy1'
           *  Sum: '<S302>/Sum1'
           */
           ...
           *  RelationalOperator: '<S309>/Compare'
           *  RelationalOperator: '<S310>/Compare'
           *  S-Function (sfix_bitop): '<S301>/alt_cmd valid'
           *  S-Function (sfix_bitop): '<S301>/z_cmd valid'
           *  SignalConversion: '<S31>/Signal Copy1'
           *  Sum: '<S302>/Sum1'
           */
         ...
         case 2:
           ...
           */
          rtb_a_l = arm_cos_f32(-FMS_DW.home[3]);
          rtb_Transpose[4] = rtb_a_l;

          /* Trigonometry: '<S315>/Trigonometric Function2' incorporates:
           *  DataStoreRead: '<S303>/Data Store Read'
           *  Gain: '<S313>/Gain'
           *  Trigonometry: '<S315>/Trigonometric Function'
           */
         ...
         default:
           ...
           *  SignalConversion: '<S31>/Signal Copy1'
           */
          rtb_Switch2_i = -FMS_U.INS_Out.h_R - FMS_DW.home[2];
          ...
          for (rtb_Compare_bv_0 = 0; rtb_Compare_bv_0 < 3; rtb_Compare_bv_0++) {
            ...
            rtb_MatrixConcatenate3[rtb_Compare_bv_0] = tmp_1[rtb_Compare_bv_0] ||
              ...
              ((rtb_Transpose[rtb_Compare_bv_0 + 3] * rtb_Divide_lr_idx_1 +
               ...
               rtb_Transpose[rtb_Compare_bv_0 + 6] * rtb_Switch2_i) : 0.0F;
          }
       ...
       case 1:
        ...
        /* End of Outputs for SubSystem: '<S5>/FMS_Input' */
        rtb_Divide_lr_idx_1 = rtb_Add3_c * rtb_Add3_c + rtb_Saturation_n *
          rtb_Saturation_n;
