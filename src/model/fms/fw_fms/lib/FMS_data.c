...
const ConstB_FMS_T FMS_ConstB = {
  ...
  10U,                                 /* '<S35>/Data Type Conversion1' */
  5U,                                  /* '<S35>/Data Type Conversion2' */
  3U,                                  /* '<S34>/Data Type Conversion1' */
  9U,                                  /* '<S34>/Data Type Conversion2' */
  4U,                                  /* '<S34>/Data Type Conversion3' */
  3U,                                  /* '<S36>/Data Type Conversion' */
  8U,                                  /* '<S36>/Data Type Conversion1' */
  3U,                                  /* '<S36>/Data Type Conversion2' */
  3U,                                  /* '<S33>/Data Type Conversion' */
  7U,                                  /* '<S33>/Data Type Conversion1' */
  2U,                                  /* '<S33>/Data Type Conversion2' */
  3U,                                  /* '<S123>/Data Type Conversion' */
  4U,                                  /* '<S123>/Data Type Conversion1' */
