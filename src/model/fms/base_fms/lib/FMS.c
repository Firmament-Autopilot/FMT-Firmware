...
static boolean_T FMS_CheckCmdValid(FMS_Cmd cmd_in, PilotMode mode_in, uint32_T ins_flag);
static boolean_T FMS_BottomRight(real32_T pilot_cmd_stick_yaw, real32_T pilot_cmd_stick_throttle);
static boolean_T FMS_BottomLeft(real32_T pilot_cmd_stick_yaw, real32_T pilot_cmd_stick_throttle);
...
static real_T FMS_ManualArmEvent(real32_T pilot_cmd_stick_throttle, uint32_T pilot_cmd_mode);
 ...
 *    '<S70>/Move Control'
 */
void FMS_MoveControl(real32_T rtu_FMS_In, real32_T* rty_w_cmd_mPs, const ConstB_MoveControl_FMS_T* localC, DW_MoveControl_FMS_T* localDW)
{
    real32_T rtb_Add3_c;
   ...
   *  Sum: '<S288>/Subtract'
   */
    rtb_Subtract3_dn = (localDW->Integrator1_DSTATE - 1.0F / (1.0F - FMS_PARAM.THROTTLE_DZ) * rtb_a_hr * -FMS_PARAM.VEL_Z_LIM) + rtb_Add3_c;
   ...
   *  Sum: '<S289>/Subtract'
   */
    rtb_a_hr = (sqrtf((8.0F * fabsf(rtb_Subtract3_dn) + localC->d) * localC->d) - localC->d) * 0.5F * rtb_a_hr + rtb_Add3_c;
   ...
   *  Sum: '<S289>/Subtract6'
   */
    localDW->Integrator_DSTATE += ((rtb_a_hr / localC->d - rtb_Add4_g) * localC->Gain4 * ((rtb_Add3_c - rtb_Subtract3_dn) * 0.5F) - rtb_a_b * 78.448F)
        * 0.004F;
}
 ...
 *    '<S167>/Motion Status'
 */
void FMS_MotionStatus(real32_T rtu_motion_req, real32_T rtu_speed, MotionState* rty_state, DW_MotionStatus_FMS_T* localDW)
{
 ...
 *    '<S94>/Hold Control'
 */
void FMS_HoldControl_k(real32_T rtu_FMS_In, real32_T rtu_FMS_In_p, real32_T rtu_FMS_In_b, real32_T rty_uv_cmd_mPs[2], const ConstB_HoldControl_FMS_k_T* localC, DW_HoldControl_FMS_l_T* localDW)
{
   ...
   */
    for (i = 0; i < 3; i++) {
        rtb_VectorConcatenate_b[i] = rtb_VectorConcatenate_k[i + 3] * rtb_VectorConcatenate_b_tmp + rtb_VectorConcatenate_k[i] * rtb_VectorConcatenate_b_tmp_0;
    }
 ...
 *    '<S94>/Move Control'
 */
void FMS_MoveControl_o(real32_T rtu_FMS_In, real32_T rtu_FMS_In_g, real32_T rty_uv_cmd_mPs[2], const ConstB_MoveControl_FMS_k_T* localC,
                       DW_MoveControl_FMS_d_T* localDW)
{
   ...
   *  Sum: '<S301>/Subtract'
   */
    rtb_Subtract3_h_idx_0 = (localDW->Integrator1_DSTATE[0] - 1.0F / (1.0F - FMS_PARAM.PITCH_DZ) * rtb_Subtract3_h_idx_1 * FMS_PARAM.VEL_XY_LIM) + rtb_Add3_e1_idx_0;
   ...
   *  Sum: '<S301>/Subtract'
   */
    rtb_Subtract3_h_idx_1 = (localDW->Integrator1_DSTATE[1] - 1.0F / (1.0F - FMS_PARAM.ROLL_DZ) * rtb_Subtract3_h_idx_1 * FMS_PARAM.VEL_XY_LIM) + rtb_Add3_e1_idx_1;
   ...
   *  Sum: '<S302>/Subtract'
   */
    rtb_Subtract3_h_idx_0_0 = (sqrtf((8.0F * fabsf(rtb_Subtract3_h_idx_0) + localC->d) * localC->d) - localC->d) * 0.5F * rtb_Subtract3_h_idx_0_0 + rtb_Add3_e1_idx_0;
   ...
   *  Sum: '<S302>/Subtract6'
   */
    localDW->Integrator_DSTATE[0] += ((rtb_Subtract3_h_idx_0_0 / localC->d - rtb_Subtract3_h_idx_0) * localC->Gain4 * ((u - rtb_Add3_e1_idx_0) * 0.5F) - rtb_Subtract3_nv * 58.836F) * 0.004F;
   ...
   *  Sum: '<S302>/Subtract'
   */
    rtb_Subtract3_h_idx_0_0 = (sqrtf((8.0F * fabsf(rtb_Subtract3_h_idx_1) + localC->d) * localC->d) - localC->d) * 0.5F * rtb_Add3_e1_idx_0 + rtb_Add3_e1_idx_1;
   ...
   *  Sum: '<S302>/Subtract6'
   */
    localDW->Integrator_DSTATE[1] += ((rtb_Subtract3_h_idx_0_0 / localC->d - rtb_Subtract3_h_idx_0) * localC->Gain4 * ((u - rtb_Add3_e1_idx_0) * 0.5F) - rtb_Subtract3_nv * 58.836F) * 0.004F;
}
 ...
 *    '<S177>/Motion State'
 */
void FMS_MotionState(real32_T rtu_motion_req, real32_T rtu_speed, MotionState* rty_state, DW_MotionState_FMS_T* localDW)
{
 ...
 *    '<S157>/NearbyRefWP'
 */
void FMS_NearbyRefWP(const real32_T rtu_P2[2], real32_T rtu_P3, real32_T rtu_P3_g, real32_T rtu_L1, real32_T rty_P[2], real32_T* rty_d)
{
    real32_T P3P2_idx_0;
    real32_T P3P2_idx_1;
                       ...
                       const ConstB_MoveControl_FMS_f_T* localC, DW_MoveControl_FMS_c_T* localDW)
{
   ...
   *  Sum: '<S234>/Subtract'
   */
    rtb_Subtract3_i = (localDW->Integrator1_DSTATE - 1.0F / (1.0F - FMS_PARAM.YAW_DZ) * rtb_a_b * FMS_PARAM.YAW_RATE_LIM) + rtb_Add3_a;
   ...
   *  Sum: '<S235>/Subtract'
   */
    rtb_a_b = (sqrtf((8.0F * fabsf(rtb_Subtract3_i) + localC->d) * localC->d) - localC->d) * 0.5F * rtb_a_b + rtb_Add3_a;
   ...
   *  Sum: '<S235>/Subtract6'
   */
    localDW->Integrator_DSTATE += ((rtb_a_b / localC->d - rtb_Add4_bf) * localC->Gain4 * ((rtb_Add3_a - rtb_Subtract3_i) * 0.5F) - rtb_a_p * 15.707963F) * 0.004F;
}
 ...
 *    '<S82>/Motion State'
 */
void FMS_MotionState_e(boolean_T rtu_motion_req, real32_T rtu_speed, MotionState* rty_state, DW_MotionState_FMS_g_T* localDW)
{
...
void F_VehicleArmAutoMissionLLA2FLAT(const real_T rtu_lla[3], const real_T rtu_llo[2], real_T rtu_href, real_T rtu_psio, real32_T rty_pos[3], const ConstB_VehicleArmAutoMissionL_T* localC)
{
    real_T rtb_Sum2_m;
    real_T rtb_Gain_d;
    real_T rtb_Sum3;
...
static boolean_T FMS_CheckCmdValid(FMS_Cmd cmd_in, PilotMode mode_in, uint32_T ins_flag)
{
    ...
    case FMS_Cmd_Return:
    case FMS_Cmd_Pause:
        if (((ins_flag & 1U) != 0U) && ((ins_flag & 4U) != 0U) && ((ins_flag & 8U) != 0U) && ((ins_flag & 16U) != 0U) && ((ins_flag & 64U) != 0U) && ((ins_flag & 128U) != 0U)) {
            valid = true;
        }
        break;

    case FMS_Cmd_PreArm:
        if (((ins_flag & 1U) == 0U) || ((ins_flag & 4U) == 0U) || ((ins_flag & 8U) == 0U)) {
        } else {
            switch (mode_in) {
            case PilotMode_Position:
            case PilotMode_Mission:
                if (((ins_flag & 16U) != 0U) && ((ins_flag & 64U) != 0U) && ((ins_flag & 128U) != 0U)) {
                    valid = true;
                }
                break;
...
static boolean_T FMS_sf_msg_pop_M(void)
{
    ...
    if (FMS_DW.M_isValid) {
        ...
        FMS_DW.M_msgHandle = FMS_pop(&FMS_DW.Queue_FMS_Cmd_p, &FMS_DW.Msg_FMS_Cmd_c[0]) != 0 ? (void*)&FMS_DW.Msg_FMS_Cmd_c[0] : NULL;
...
static void FMS_enter_internal_Arm(void)
{
    ...
    if (tmp == 3.0) {
        ...
        case PilotMode_Mission:
            ...
            FMS_DW.llo[0] = FMS_B.BusConversion_InsertedFor_FMSSt.lat_0 * 57.295779513082323;
            FMS_DW.llo[1] = FMS_B.BusConversion_InsertedFor_FMSSt.lon_0 * 57.295779513082323;
...
static void FMS_SubMode(void)
{
   ...
   *  Sum: '<S333>/Sum'
   */
    FMS_B.Compare = (fmax(fmax(fmax(fabs(FMS_B.stick_val[0] - FMS_B.pilot_cmd.stick_yaw), fabs(FMS_B.stick_val[1] - FMS_B.pilot_cmd.stick_throttle)), fabs(FMS_B.stick_val[2] - FMS_B.pilot_cmd.stick_roll)), fabs(FMS_B.stick_val[3] - FMS_B.pilot_cmd.stick_pitch)) >= 0.1);
    ...
    if (FMS_B.Compare && (FMS_B.target_mode != PilotMode_None)) {
        ...
        if (b_sf_internal_predicateOutput) {
            ...
            case FMS_IN_Hold_h:
                if (FMS_sf_msg_pop_M()) {
                    b_sf_internal_predicateOutput = ((FMS_DW.M_msgReservedData == FMS_Cmd_Continue) && (FMS_B.target_mode != PilotMode_None));
                } else {
                    b_sf_internal_predicateOutput = false;
                }
            ...
            case FMS_IN_Land:
                ...
                if (FMS_DW.chartAbsoluteTimeCounter - FMS_DW.durationLastReferenceTick_1_j >= 500) {
                    FMS_DW.is_SubMode = FMS_IN_NO_ACTIVE_CHILD_h;
                    FMS_DW.is_Arm = FMS_IN_NO_ACTIVE_CHILD_h;
            ...
            case FMS_IN_Takeoff:
                if (FMS_B.BusConversion_InsertedFor_FMSSt.h_R >= FMS_B.Cmd_In.sp_takeoff[2]) {
...
static void FMS_Arm(void)
{
    ...
    if ((FMS_DW.chartAbsoluteTimeCounter - FMS_DW.durationLastReferenceTick_1_c >= 500) && (FMS_B.target_mode != PilotMode_Mission)) {
        FMS_exit_internal_Arm();
        FMS_DW.is_Vehicle = FMS_IN_Disarm;
        FMS_B.state = VehicleState_Disarm;
    } else if ((FMS_DW.mode_prev != FMS_DW.mode_start) && (FMS_B.target_mode != PilotMode_None)) {
        ...
        if (c_sf_internal_predicateOutput) {
            ...
            if (FMS_sf_msg_pop_M()) {
                c_sf_internal_predicateOutput = (FMS_DW.M_msgReservedData == FMS_Cmd_Return);
            } else {
                c_sf_internal_predicateOutput = false;
            }
            ...
            if (c_sf_internal_predicateOutput) {
                ...
                case FMS_IN_Auto:
                    if (FMS_sf_msg_pop_M()) {
                        c_sf_internal_predicateOutput = (FMS_DW.M_msgReservedData == FMS_Cmd_Pause);
                    } else {
                        c_sf_internal_predicateOutput = false;
                    }
                        ...
                        case FMS_IN_Mission:
                            if (FMS_DW.mission_timestamp_prev != FMS_DW.mission_timestamp_start) {
                                ...
                                case FMS_IN_Land:
                                    ...
                                    if (FMS_DW.chartAbsoluteTimeCounter - FMS_DW.durationLastReferenceTick_1 >= 500) {
                                ...
                                case FMS_IN_NextWP:
                                    if (FMS_DW.nav_cmd == (int32_T)NAV_Cmd_Takeoff) {
                                        ...
                                        F_VehicleArmAutoMissionLLA2FLAT(FMS_B.lla, FMS_B.llo, FMS_B.href, FMS_B.psio, FMS_B.DataTypeConversion, &FMS_ConstB.VehicleArmAutoMissionLLA2FLAT);
                                ...
                                case FMS_IN_Return_h:
                                    tmp[0] = FMS_B.BusConversion_InsertedFor_FMSSt.x_R - FMS_B.Cmd_In.sp_return[0];
                                    tmp[1] = FMS_B.BusConversion_InsertedFor_FMSSt.y_R - FMS_B.Cmd_In.sp_return[1];
                                ...
                                case FMS_IN_Waypoint:
                                    tmp[0] = FMS_B.BusConversion_InsertedFor_FMSSt.x_R - FMS_B.Cmd_In.sp_waypoint[0];
                                    tmp[1] = FMS_B.BusConversion_InsertedFor_FMSSt.y_R - FMS_B.Cmd_In.sp_waypoint[1];
...
static void FMS_Vehicle(void)
{
    ...
    if (sf_internal_predicateOutput) {
        ...
        case FMS_IN_Standby:
            ...
            if ((!sf_internal_predicateOutput) || (!FMS_DW.condWasTrueAtLastTimeStep_1_k)) {
        ...
        case FMS_IN_Disarm:
            if (FMS_sf_msg_pop_M()) {
                sf_internal_predicateOutput = (FMS_DW.M_msgReservedData == FMS_Cmd_PreArm);
            } else {
                sf_internal_predicateOutput = false;
            }
            ...
            if (sf_internal_predicateOutput) {
                ...
                if (FMS_sf_msg_pop_M()) {
                    sf_internal_predicateOutput = (FMS_DW.M_msgReservedData == FMS_Cmd_Takeoff);
                } else {
                    sf_internal_predicateOutput = false;
                }
        ...
        case FMS_IN_Standby:
            if ((FMS_ManualArmEvent(FMS_B.BusConversion_InsertedFor_FMS_f.stick_throttle,
                                    FMS_B.BusConversion_InsertedFor_FMS_f.mode)
                 == 1.0)
                ...
                FMS_DW.condWasTrueAtLastTimeStep_1_k = sf_internal_predicateOutput;
                if (FMS_DW.chartAbsoluteTimeCounter - FMS_DW.durationLastReferenceTick_1_k >= 500) {
                    guard3 = true;
                } else {
                    if (FMS_sf_msg_pop_M()) {
                        sf_internal_predicateOutput = (FMS_DW.M_msgReservedData == FMS_Cmd_Takeoff);
                    ...
                    if (sf_internal_predicateOutput) {
                        guard3 = true;
                    } else if ((FMS_DW.temporalCounter_i1 >= 2500U) || (FMS_DW.sfEvent == FMS_event_DisarmEvent)) {
                        FMS_DW.prep_takeoff = 0.0;
                        sf_internal_predicateOutput = (FMS_DW.prep_takeoff == 1.0);
                        if ((!sf_internal_predicateOutput) || (!FMS_DW.condWasTrueAtLastTimeStep_1_k)) {
                            FMS_DW.durationLastReferenceTick_1_k = FMS_DW.chartAbsoluteTimeCounter;
                        ...
                        FMS_DW.condWasTrueAtLastTimeStep_2 = sf_internal_predicateOutput;
                        if (FMS_DW.chartAbsoluteTimeCounter - FMS_DW.durationLastReferenceTick_2 >= 500) {
                            guard2 = true;
                        }
                    }
                }
       ...
       */
        ...
        if (guard1) {
            ...
            if (FMS_B.target_mode == PilotMode_Mission) {
                if ((FMS_B.wp_index <= FMS_U.Mission_Data.valid_items) && (FMS_U.Mission_Data.command[FMS_B.wp_index - 1] == (int32_T)NAV_Cmd_Takeoff)) {
    ...
    if (FMS_DW.is_active_c11_FMS == 0U) {
        ...
        if (FMS_DW.is_active_Combo_Stick != 0U) {
            ...
            case FMS_IN_Idle:
                ...
                FMS_DW.condWasTrueAtLastTimeStep_1_h = FMS_DW.br;
                if (FMS_DW.chartAbsoluteTimeCounter - FMS_DW.durationLastReferenceTick_1_n > 375) {
                    ...
                    FMS_DW.condWasTrueAtLastTimeStep_2_g = FMS_DW.bl;
                    if (FMS_DW.chartAbsoluteTimeCounter - FMS_DW.durationLastReferenceTick_2_a > 375) {
                        ...
                        FMS_DW.bl = FMS_BottomLeft(FMS_B.BusConversion_InsertedFor_FMS_f.stick_yaw,
                                                   FMS_B.BusConversion_InsertedFor_FMS_f.stick_throttle);
                        if ((!FMS_DW.bl) || (!FMS_DW.condWasTrueAtLastTimeStep_2_g)) {
                            FMS_DW.durationLastReferenceTick_2_a = FMS_DW.chartAbsoluteTimeCounter;
                        }
                        ...
                        FMS_DW.condWasTrueAtLastTimeStep_2_g = FMS_DW.bl;
                        FMS_DW.br = FMS_BottomRight(FMS_B.BusConversion_InsertedFor_FMS_f.stick_yaw,
                                                    FMS_B.BusConversion_InsertedFor_FMS_f.stick_throttle);
                        if ((!FMS_DW.br) || (!FMS_DW.condWasTrueAtLastTimeStep_1_h)) {
                            FMS_DW.durationLastReferenceTick_1_n = FMS_DW.chartAbsoluteTimeCounter;
                        }
...
static void initialize_msg_local_queues_for(void)
{
    FMS_initQueue((Queue_FMS_Cmd*)&FMS_DW.Queue_FMS_Cmd_p, MSG_FIFO_QUEUE, 10, (Msg_FMS_Cmd*)&FMS_DW.Msg_FMS_Cmd_c[1]);
}
...
void FMS_step(void)
{
   ...
   */
    rtb_Square2 = sqrtf(((FMS_U.INS_Out.quat[0] * FMS_U.INS_Out.quat[0] + FMS_U.INS_Out.quat[1] * FMS_U.INS_Out.quat[1]) + FMS_U.INS_Out.quat[2] * FMS_U.INS_Out.quat[2]) + FMS_U.INS_Out.quat[3] * FMS_U.INS_Out.quat[3]);
   ...
   *  Sum: '<S351>/Add1'
   */
    rtb_Transpose[0] = (rtb_Rem_k + rtb_Saturation_l) - (rtb_MathFunction_cr_idx_0 + rtb_Divide);
   ...
   *  Sum: '<S351>/Subtract1'
   */
    rtb_Transpose[1] = (rtb_MathFunction_h_idx_0 - rtb_MathFunction_cr_idx_1) * 2.0F;
   ...
   *  Sum: '<S351>/Add2'
   */
    rtb_Transpose[2] = (rtb_MathFunction_iq_idx_0 + rtb_MathFunction_iq_idx_1) * 2.0F;

    /* Gain: '<S352>/Gain' incorporates:
   *  Sum: '<S352>/Add3'
   */
    rtb_Transpose[3] = (rtb_MathFunction_h_idx_0 + rtb_MathFunction_cr_idx_1) * 2.0F;

    /* Sum: '<S352>/Subtract' incorporates:
   *  Sum: '<S352>/Add'
   *  Sum: '<S352>/Add1'
   */
    rtb_Transpose[4] = (rtb_Rem_k + rtb_MathFunction_cr_idx_0) - (rtb_Saturation_l + rtb_Divide);
   ...
   *  Sum: '<S352>/Subtract1'
   */
    rtb_Transpose[5] = (rtb_MathFunction_h_idx_0 - rtb_MathFunction_cr_idx_1) * 2.0F;

    /* Gain: '<S353>/Gain' incorporates:
   *  Sum: '<S353>/Subtract2'
   */
    rtb_Transpose[6] = (rtb_MathFunction_iq_idx_0 - rtb_MathFunction_iq_idx_1) * 2.0F;

    /* Gain: '<S353>/Gain1' incorporates:
   *  Sum: '<S353>/Add2'
   */
    rtb_Transpose[7] = (rtb_MathFunction_h_idx_0 + rtb_MathFunction_cr_idx_1) * 2.0F;

    /* Sum: '<S353>/Subtract' incorporates:
   *  Sum: '<S353>/Add'
   *  Sum: '<S353>/Add1'
   */
    rtb_Transpose[8] = (rtb_Rem_k + rtb_Divide) - (rtb_Saturation_l + rtb_MathFunction_cr_idx_0);
   ...
   */
    for (i = 0; i < 3; i++) {
        rtb_Multiply[i] = rtb_Transpose[i + 6] * FMS_U.INS_Out.az + (rtb_Transpose[i + 3] * FMS_U.INS_Out.ay + rtb_Transpose[i] * FMS_U.INS_Out.ax);
    }
   ...
   */
    FMS_B.on_ground = ((-0.5F <= FMS_DW.DiscreteTimeIntegrator5_DSTATE[0]) && (FMS_DW.DiscreteTimeIntegrator5_DSTATE[0] <= 0.5F) && ((-0.5F <= FMS_DW.DiscreteTimeIntegrator5_DSTATE[1]) && (FMS_DW.DiscreteTimeIntegrator5_DSTATE[1] <= 0.5F)) && ((-10.306F <= FMS_DW.DiscreteTimeIntegrator5_DSTATE[2]) && (FMS_DW.DiscreteTimeIntegrator5_DSTATE[2] <= -9.306F)) && (FMS_DW.DiscreteTimeIntegrator5_DSTAT_d < 1250.0F));
   ...
   *  Store in Global RAM
   */
    if ((FMS_U.Pilot_Cmd.mode != 0U) && (FMS_DW.DiscreteTimeIntegrator1_DSTATE < 500U)) {
        FMS_DW.Delay_DSTATE_c = (PilotMode)FMS_U.Pilot_Cmd.mode;
    } else {
        if ((FMS_U.GCS_Cmd.mode != FMS_DW.DelayInput1_DSTATE_f) && (FMS_U.GCS_Cmd.mode != 0U)) {
   ...
   */
     ...
     */
       ...
       */
         ...
         *  Sum: '<S328>/Sum2'
         */
                rtb_Saturation_l = 1.0F / (FMS_B.Cmd_In.sp_takeoff[2] - FMS_B.Cmd_In.cur_waypoint[2]) * rtb_Divide_l_idx_2;
         ...
         *  Sum: '<S328>/Sum4'
         */
                rtb_Divide_l_idx_1 = ((FMS_B.Cmd_In.sp_takeoff[0] - FMS_B.Cmd_In.cur_waypoint[0]) * rtb_Saturation_l + FMS_B.Cmd_In.cur_waypoint[0]) - FMS_U.INS_Out.x_R;
                rtb_Saturation_l = ((FMS_B.Cmd_In.sp_takeoff[1] - FMS_B.Cmd_In.cur_waypoint[1]) * rtb_Saturation_l + FMS_B.Cmd_In.cur_waypoint[1]) - FMS_U.INS_Out.y_R;

                /* End of Outputs for SubSystem: '<S2>/FMS_Input' */

                /* Product: '<S323>/Multiply' */
                for (i = 0; i < 3; i++) {
                    rtb_Transpose_1[i] = rtb_Transpose[i + 3] * rtb_Saturation_l + rtb_Transpose[i] * rtb_Divide_l_idx_1;
                }
         ...
         *  Sum: '<S322>/Sum1'
         */
                if ((fabsf(FMS_B.Cmd_In.sp_takeoff[2] - FMS_U.INS_Out.h_R) > 2.0F) && (fabsf(rtb_Divide_l_idx_2) > 2.0F)) {
                    /* BusAssignment: '<S210>/Bus Assignment1' incorporates:
           *  BusAssignment: '<S19>/Bus Assignment'
         ...
         *  Sum: '<S292>/Add'
         */
                FMS_MotionState(0.0F, sqrtf(FMS_U.INS_Out.vn * FMS_U.INS_Out.vn + FMS_U.INS_Out.ve * FMS_U.INS_Out.ve), &rtb_state_a, &FMS_DW.sf_MotionState);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl_k(FMS_U.INS_Out.x_R, FMS_U.INS_Out.y_R, FMS_U.INS_Out.psi, FMS_B.Merge_mv, &FMS_ConstB.HoldControl_k, &FMS_DW.HoldControl_k);
           ...
           */
                    ...
                    FMS_MoveControl_o(FMS_U.Pilot_Cmd.stick_pitch,
                                      ...
                                      FMS_B.Merge_mv,
                                      &FMS_ConstB.MoveControl_o,
                                      &FMS_DW.MoveControl_o);
         ...
         *  SignalConversion: '<S17>/Signal Copy1'
         */
                FMS_MotionStatus(0.0F, fabsf(FMS_U.INS_Out.vd), &rtb_state_a, &FMS_DW.sf_MotionStatus);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl(FMS_U.INS_Out.h_R, &FMS_B.Merge_mu, &FMS_DW.HoldControl);
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_MoveControl(FMS_U.Pilot_Cmd.stick_throttle, &FMS_B.Merge_mu, &FMS_ConstB.MoveControl, &FMS_DW.MoveControl);
         ...
         *  SignalConversion: '<S17>/TmpSignal ConversionAtSignal Copy3Inport1'
         */
                rtb_MathFunction_h_idx_0 = FMS_B.Cmd_In.sp_return[0] - FMS_DW.Delay_DSTATE_p[0];
         ...
         *  Sum: '<S209>/Sum'
         */
                rtb_Square2 = rtb_Divide * rtb_Divide + rtb_MathFunction_h_idx_0 * rtb_MathFunction_h_idx_0;
         ...
         */
                ...
                /* Product: '<S272>/Divide' */
                rtb_Saturation1_ln[0] = rtb_MatrixConcatenate3[0] / rtb_MatrixConcatenate3[2];
                rtb_Saturation1_ln[1] = rtb_MatrixConcatenate3[1] / rtb_MatrixConcatenate3[2];

                /* Sum: '<S270>/Subtract' incorporates:
         *  Product: '<S270>/Multiply'
         *  Product: '<S270>/Multiply1'
         */
                rtb_Saturation_l = rtb_Saturation1_ln[0] * FMS_ConstB.Divide_d[1] - rtb_Saturation1_ln[1] * FMS_ConstB.Divide_d[0];
         ...
         */
                ...
                rtb_Divide_l_idx_1 = FMS_ConstB.Divide_d[0] * rtb_Saturation1_ln[0] + FMS_ConstB.Divide_d[1] * rtb_Saturation1_ln[1];
         ...
         */
           ...
           *  SignalConversion: '<S17>/TmpSignal ConversionAtSignal Copy3Inport1'
           */
                    rtb_Divide_l_idx_1 = FMS_B.Cmd_In.sp_return[0] - FMS_DW.Delay_DSTATE_e[0];
           ...
           *  SignalConversion: '<S17>/TmpSignal ConversionAtSignal Copy3Inport1'
           */
                    rtb_Divide_l_idx_1 = FMS_B.Cmd_In.sp_return[1] - FMS_DW.Delay_DSTATE_e[1];
           ...
           */
                    rtb_Square2 = rtb_MatrixConcatenate3[0] * rtb_MatrixConcatenate3[0] + rtb_Divide_l_idx_1 * rtb_Divide_l_idx_1;
           ...
           */
                    ...
                    rtb_Divide_l_idx_1 = rtb_Divide_l_idx_1 / rtb_Square2 * rtb_Divide_l_idx_2;
                    for (i = 0; i < 3; i++) {
                        rtb_MatrixConcatenate3[i] = rtb_Transpose[i + 3] * rtb_Divide_l_idx_1 + rtb_Transpose[i] * A;
                    }
                }
         ...
         */
                rtb_Square2 = FMS_U.INS_Out.vn * FMS_U.INS_Out.vn + FMS_U.INS_Out.ve * FMS_U.INS_Out.ve;
         ...
         */
                rtb_Divide_l_idx_1 = rtb_Saturation1_ln[1] * rtb_Saturation1_ln[1] + rtb_Saturation1_ln[0] * rtb_Saturation1_ln[0];
         ...
         *  SignalConversion: '<S17>/Signal Copy1'
         */
                FMS_NearbyRefWP(rtb_Divide_o, FMS_U.INS_Out.x_R, FMS_U.INS_Out.y_R, FMS_PARAM.L1, rtb_Saturation1_ln, &rtb_MathFunction_cr_idx_0);
         ...
         *  SignalConversion: '<S17>/Signal Copy1'
         */
                A = rtb_MathFunction_h_idx_0 * rtb_MathFunction_h_idx_0 + rtb_Divide * rtb_Divide;

                /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                B = (rtb_MathFunction_h_idx_0 * (FMS_DW.Delay_DSTATE_p[0] - FMS_U.INS_Out.x_R) + rtb_Divide * (FMS_DW.Delay_DSTATE_p[1] - FMS_U.INS_Out.y_R)) * 2.0F;
                D = B * B - (((((FMS_U.INS_Out.x_R * FMS_U.INS_Out.x_R + FMS_U.INS_Out.y_R * FMS_U.INS_Out.y_R) + FMS_DW.Delay_DSTATE_p[0] * FMS_DW.Delay_DSTATE_p[0]) + FMS_DW.Delay_DSTATE_p[1] * FMS_DW.Delay_DSTATE_p[1]) - (FMS_U.INS_Out.x_R * FMS_DW.Delay_DSTATE_p[0] + FMS_U.INS_Out.y_R * FMS_DW.Delay_DSTATE_p[1]) * 2.0F) - FMS_PARAM.L1 * FMS_PARAM.L1) * (4.0F * A);
                ...
                if (guard1) {
                    rtb_MathFunction_iq_idx_0 = rtb_MathFunction_h_idx_0 * rtb_Divide_l_idx_1 + FMS_DW.Delay_DSTATE_p[0];
                    rtb_MathFunction_iq_idx_1 = rtb_Divide * rtb_Divide_l_idx_1 + FMS_DW.Delay_DSTATE_p[1];
                }
         ...
         *  SignalConversion: '<S17>/TmpSignal ConversionAtSignal Copy3Inport1'
         */
                A = ((FMS_U.INS_Out.y_R - FMS_DW.Delay_DSTATE_p[1]) * rtb_Divide + (FMS_U.INS_Out.x_R - FMS_DW.Delay_DSTATE_p[0]) * rtb_MathFunction_h_idx_0) / (rtb_MathFunction_h_idx_0 * rtb_MathFunction_h_idx_0 + rtb_Divide * rtb_Divide);
                ...
                if (rtb_FixPtRelationalOperator_n) {
                    ...
                    rtb_MathFunction_h_idx_0 = A * rtb_MathFunction_h_idx_0 + FMS_DW.Delay_DSTATE_p[0];
                }
         ...
         */
                ...
                rtb_TmpSignalConversionAtDela_a[0] = rtb_MathFunction_cr_idx_1 * rtb_MathFunction_cr_idx_1;
         ...
         *  Math: '<S311>/Square'
         */
                rtb_Divide_l_idx_1 = rtb_MathFunction_cr_idx_1 * rtb_MathFunction_cr_idx_1;
         ...
         */
                ...
                /* Math: '<S311>/Square' */
                rtb_TmpSignalConversionAtDela_a[0] = rtb_Saturation1_ln[0] * rtb_Saturation1_ln[0];
                rtb_Saturation1_ln[0] = rtb_MatrixConcatenate3[0] / rtb_MatrixConcatenate3[2];
         ...
         */
                rtb_Rem_k = rtb_Divide_o[0] * rtb_Divide - rtb_Divide_o[1] * rtb_Saturation1_ln[0];
         ...
         */
                ...
                rtb_Divide = rtb_Saturation1_ln[0] * rtb_Divide_o[0] + rtb_Divide * rtb_Divide_o[1];
         ...
         */
                rtb_Square2 = arm_sin_f32(rtb_Rem_k) * rtb_Square2 / fminf(FMS_PARAM.L1, fmaxf(sqrtf(rtb_Divide_l_idx_1 + rtb_TmpSignalConversionAtDela_a[0]), 0.5F));
         ...
         *  Sum: '<S261>/Subtract'
         */
                rtb_Rem_k = (FMS_DW.Integrator1_DSTATE_e - rtb_Divide_l_idx_1) + rtb_MathFunction_cr_idx_0;
         ...
         *  Sum: '<S267>/Subtract'
         */
                rtb_Saturation_l = (sqrtf((8.0F * fabsf(rtb_Rem_k) + FMS_ConstB.d_l) * FMS_ConstB.d_l) - FMS_ConstB.d_l) * 0.5F * rtb_Divide_l_idx_1 + rtb_MathFunction_cr_idx_0;
         ...
         *  Sum: '<S267>/Subtract6'
         */
                FMS_DW.Integrator_DSTATE_bs += ((rtb_Saturation_l / FMS_ConstB.d_l - rtb_Divide_l_idx_2) * FMS_ConstB.Gain4_np * ((rtb_Divide_l_idx_1 - A) * 0.5F) - rtb_Square2 * 1.04719758F) * 0.004F;
         ...
         *  SignalConversion: '<S17>/Signal Copy1'
         */
                FMS_MotionStatus(0.0F, fabsf(FMS_U.INS_Out.vd), &rtb_state_a, &FMS_DW.sf_MotionStatus_j);
         ...
         */
                ...
                if (FMS_DW.is_active_c15_FMS == 0U) {
                    ...
                    case FMS_IN_Brake_o:
                        ...
                        /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                        if ((fabsf(FMS_U.INS_Out.r) <= 0.1) || (FMS_DW.temporalCounter_i1_a >= 250U)) {
         ...
         *  Sum: '<S238>/Add'
         */
                FMS_MotionState(0.0F, sqrtf(FMS_U.INS_Out.vn * FMS_U.INS_Out.vn + FMS_U.INS_Out.ve * FMS_U.INS_Out.ve), &rtb_state_l, &FMS_DW.sf_MotionState_g);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl_k(FMS_U.INS_Out.x_R, FMS_U.INS_Out.y_R, FMS_U.INS_Out.psi, FMS_B.Merge_o, &FMS_ConstB.HoldControl_f, &FMS_DW.HoldControl_f);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl(FMS_U.INS_Out.h_R, &FMS_B.Merge_ey, &FMS_DW.HoldControl_n);
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_MoveControl(FMS_U.Pilot_Cmd.stick_throttle, &FMS_B.Merge_ey, &FMS_ConstB.MoveControl_n, &FMS_DW.MoveControl_n);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl_kq(FMS_U.INS_Out.psi, &FMS_B.Merge_n1, &FMS_DW.HoldControl_kq);
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_MoveControl_b(FMS_U.Pilot_Cmd.stick_yaw, &FMS_B.Merge_n1, &FMS_ConstB.MoveControl_b, &FMS_DW.MoveControl_b);
       ...
       */
            ...
            /* End of Outputs for SubSystem: '<S2>/FMS_Input' */
            if ((rtPrevAction != FMS_DW.SwitchCase_ActiveSubsystem_i) && (rtPrevAction == 1)) {
                /* Disable for Resettable SubSystem: '<S131>/Mission_SubSystem' */
                /* Disable for SwitchCase: '<S176>/Switch Case' */
                FMS_DW.SwitchCase_ActiveSubsystem_a = -1;
         ...
         *  Store in Global RAM
         */
                rtb_FixPtRelationalOperator_n = (FMS_B.wp_index != FMS_DW.DelayInput1_DSTATE_pe);
         ...
         */
                if (rtb_FixPtRelationalOperator_n && (FMS_PrevZCX.Mission_SubSystem_Reset_ZCE != POS_ZCSIG)) {
                    /* Disable for SwitchCase: '<S176>/Switch Case' */
                    FMS_DW.SwitchCase_ActiveSubsystem_a = -1;
         ...
         */
                ...
                /* End of Outputs for SubSystem: '<S2>/FMS_Input' */
                rtb_TmpSignalConversionAtDela_a[0] = rtb_Divide_l_idx_1 * rtb_Divide_l_idx_1;
         ...
         */
                rtb_Divide_l_idx_1 = sqrtf(rtb_TmpSignalConversionAtDela_a[0] + rtb_Divide_l_idx_1);
         ...
         *  Sum: '<S177>/Add'
         */
                FMS_MotionState(0.0F, sqrtf(FMS_U.INS_Out.vn * FMS_U.INS_Out.vn + FMS_U.INS_Out.ve * FMS_U.INS_Out.ve), &rtb_state_a, &FMS_DW.sf_MotionState_n);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl_k(FMS_U.INS_Out.x_R, FMS_U.INS_Out.y_R, FMS_U.INS_Out.psi, FMS_B.Merge_n, &FMS_ConstB.HoldControl_d, &FMS_DW.HoldControl_d);
         ...
         *  SignalConversion: '<S17>/Signal Copy1'
         */
                FMS_MotionStatus(0.0F, fabsf(FMS_U.INS_Out.vd), &rtb_state_a, &FMS_DW.sf_MotionStatus_jt);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl(FMS_U.INS_Out.h_R, &FMS_B.Merge_e, &FMS_DW.HoldControl_a);
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_MoveControl(FMS_U.Pilot_Cmd.stick_throttle, &FMS_B.Merge_e, &FMS_ConstB.MoveControl_m, &FMS_DW.MoveControl_m);
         ...
         *  Switch: '<S137>/Switch'
         */
                rtb_MathFunction_h_idx_0 = FMS_B.Cmd_In.sp_waypoint[0] - FMS_B.Cmd_In.cur_waypoint[0];
         ...
         */
                ...
                /* Product: '<S153>/Divide' */
                rtb_TmpSignalConversionAtDela_a[0] = rtb_MathFunction_cr_idx_0 / rtb_Rem_k;
                rtb_TmpSignalConversionAtDela_a[1] = rtb_MathFunction_cr_idx_1 / rtb_Rem_k;

                /* Sum: '<S151>/Subtract' incorporates:
         *  Product: '<S151>/Multiply'
         *  Product: '<S151>/Multiply1'
         */
                rtb_Saturation_l = rtb_TmpSignalConversionAtDela_a[0] * FMS_ConstB.Divide[1] - rtb_TmpSignalConversionAtDela_a[1] * FMS_ConstB.Divide[0];
         ...
         */
                ...
                rtb_Divide_l_idx_1 = FMS_ConstB.Divide[0] * rtb_TmpSignalConversionAtDela_a[0] + FMS_ConstB.Divide[1] * rtb_TmpSignalConversionAtDela_a[1];
         ...
         */
           ...
           *  SignalConversion: '<S17>/TmpSignal ConversionAtSignal Copy3Inport1'
           */
                    rtb_Divide_l_idx_1 = FMS_B.Cmd_In.sp_waypoint[0] - FMS_DW.Delay_DSTATE[0];
           ...
           *  SignalConversion: '<S17>/TmpSignal ConversionAtSignal Copy3Inport1'
           */
                    rtb_Divide_l_idx_1 = FMS_B.Cmd_In.sp_waypoint[1] - FMS_DW.Delay_DSTATE[1];
           ...
           */
                    rtb_Square2 = rtb_MathFunction_cr_idx_0 * rtb_MathFunction_cr_idx_0 + rtb_Divide_l_idx_1 * rtb_Divide_l_idx_1;
           ...
           */
                    ...
                    rtb_MathFunction_cr_idx_0 = FMS_U.INS_Out.y_R - FMS_B.Cmd_In.cur_waypoint[1];
           ...
           */
                    rtb_Rem_k = sqrtf(rtb_Rem_k * rtb_Rem_k + rtb_MathFunction_cr_idx_0 * rtb_MathFunction_cr_idx_0) / sqrtf(rtb_MathFunction_h_idx_0 * rtb_MathFunction_h_idx_0 + rtb_Divide * rtb_Divide);
           ...
           */
                    ...
                    /* Product: '<S159>/Multiply' */
                    for (i = 0; i < 3; i++) {
                        rtb_Transpose_1[i] = rtb_Transpose[i + 3] * rtb_Divide_l_idx_1 + rtb_Transpose[i] * A;
                    }
           ...
           *  Sum: '<S160>/Subtract'
           */
                    rtb_Rem_k = (FMS_U.INS_Out.h_R - ((FMS_B.Cmd_In.sp_waypoint[2] - FMS_B.Cmd_In.cur_waypoint[2]) * rtb_Rem_k + FMS_B.Cmd_In.cur_waypoint[2])) * FMS_PARAM.Z_P;
         ...
         *  SignalConversion: '<S17>/Signal Copy1'
         */
                FMS_NearbyRefWP(&rtb_MatrixConcatenate3[0], FMS_U.INS_Out.x_R, FMS_U.INS_Out.y_R, FMS_PARAM.L1, rtb_TmpSignalConversionAtDela_a, &rtb_Square2);
         ...
         */
                ...
                /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                B = (rtb_MathFunction_h_idx_0 * (FMS_B.Cmd_In.cur_waypoint[0] - FMS_U.INS_Out.x_R) + rtb_Divide * (FMS_B.Cmd_In.cur_waypoint[1] - FMS_U.INS_Out.y_R)) * 2.0F;
                D = B * B - (((((FMS_U.INS_Out.x_R * FMS_U.INS_Out.x_R + FMS_U.INS_Out.y_R * FMS_U.INS_Out.y_R) + FMS_B.Cmd_In.cur_waypoint[0] * FMS_B.Cmd_In.cur_waypoint[0]) + FMS_B.Cmd_In.cur_waypoint[1] * FMS_B.Cmd_In.cur_waypoint[1]) - (FMS_U.INS_Out.x_R * FMS_B.Cmd_In.cur_waypoint[0] + FMS_U.INS_Out.y_R * FMS_B.Cmd_In.cur_waypoint[1]) * 2.0F) - FMS_PARAM.L1 * FMS_PARAM.L1) * (4.0F * A);
                ...
                if (guard1) {
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    rtb_MathFunction_iq_idx_0 = rtb_MathFunction_h_idx_0 * rtb_Divide_l_idx_1 + FMS_B.Cmd_In.cur_waypoint[0];
                    rtb_MathFunction_iq_idx_1 = rtb_Divide * rtb_Divide_l_idx_1 + FMS_B.Cmd_In.cur_waypoint[1];
         ...
         *  SignalConversion: '<S17>/TmpSignal ConversionAtSignal Copy3Inport1'
         */
                A = ((FMS_U.INS_Out.y_R - FMS_B.Cmd_In.cur_waypoint[1]) * rtb_Divide + (FMS_U.INS_Out.x_R - FMS_B.Cmd_In.cur_waypoint[0]) * rtb_MathFunction_h_idx_0) / (rtb_MathFunction_h_idx_0 * rtb_MathFunction_h_idx_0 + rtb_Divide * rtb_Divide);
                ...
                if (rtb_FixPtRelationalOperator_n) {
                    ...
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    rtb_MathFunction_h_idx_0 = A * rtb_MathFunction_h_idx_0 + FMS_B.Cmd_In.cur_waypoint[0];
           ...
           */
             ...
             */
                        if (rtb_FixPtRelationalOperator_n) {
                            ...
                            /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                            rtb_TmpSignalConversionAtDela_a[1] = A * rtb_Divide + FMS_B.Cmd_In.cur_waypoint[1];
         ...
         */
                rtb_Divide_l_idx_1 = rtb_Divide_o[1] * rtb_Divide_o[1] + rtb_Divide_o[0] * rtb_Divide_o[0];
         ...
         */
                A = sqrtf(FMS_U.INS_Out.vn * FMS_U.INS_Out.vn + FMS_U.INS_Out.ve * FMS_U.INS_Out.ve);
         ...
         */
                A = rtb_Divide_o[0] * rtb_TmpSignalConversionAtDela_a[1] - rtb_Divide_o[1] * rtb_TmpSignalConversionAtDela_a[0];
         ...
         */
                rtb_Rem_k = arm_sin_f32(A) * rtb_Rem_k / fminf(FMS_PARAM.L1, fmaxf(sqrtf(rtb_Square2 + rtb_Saturation1_ln[0]), 0.5F));
         ...
         *  Sum: '<S148>/Subtract'
         */
                rtb_Saturation_l = (sqrtf((8.0F * fabsf(A) + FMS_ConstB.d_j) * FMS_ConstB.d_j) - FMS_ConstB.d_j) * 0.5F * rtb_Divide_l_idx_1 + rtb_Square2;
         ...
         *  Sum: '<S148>/Subtract6'
         */
                FMS_DW.Integrator_DSTATE_i += ((rtb_Saturation_l / FMS_ConstB.d_j - rtb_Divide_l_idx_2) * FMS_ConstB.Gain4_c * ((rtb_Divide_l_idx_1 - A) * 0.5F) - rtb_Square2 * 1.04719758F) * 0.004F;
       ...
       */
         ...
         *  Sum: '<S114>/Subtract'
         */
                rtb_Saturation_l = (FMS_DW.Integrator1_DSTATE_j - 1.0F / (1.0F - FMS_PARAM.ROLL_DZ) * rtb_Square2 * FMS_PARAM.ROLL_PITCH_LIM) + A;
         ...
         *  Sum: '<S116>/Subtract'
         */
                rtb_Divide_l_idx_2 = (sqrtf((8.0F * fabsf(rtb_Saturation_l) + FMS_ConstB.d_d) * FMS_ConstB.d_d) - FMS_ConstB.d_d) * 0.5F * rtb_Divide_l_idx_1 + A;
         ...
         *  Sum: '<S116>/Subtract2'
         */
                rtb_Divide_l_idx_2 += (rtb_Divide_l_idx_1 - rtb_Saturation_l) * 0.5F * rtb_Square2;
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl_kq(FMS_U.INS_Out.psi, &FMS_B.Merge_j, &FMS_DW.HoldControl_h);
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_MoveControl_b(FMS_U.Pilot_Cmd.stick_yaw, &FMS_B.Merge_j, &FMS_ConstB.MoveControl_k, &FMS_DW.MoveControl_k);
         ...
         *  Sum: '<S115>/Subtract'
         */
                A = (FMS_DW.Integrator1_DSTATE_jt - 1.0F / (1.0F - FMS_PARAM.PITCH_DZ) * rtb_Square2 * -FMS_PARAM.ROLL_PITCH_LIM) + rtb_Saturation_l;
         ...
         *  Sum: '<S116>/Subtract6'
         */
                FMS_DW.Integrator_DSTATE_c += ((rtb_Divide_l_idx_2 / FMS_ConstB.d_d - rtb_Saturation_l) * FMS_ConstB.Gain4_n * ((rtb_Divide_l_idx_1 - A) * 0.5F) - rtb_Rem_k * 12.566371F) * 0.004F;
         ...
         *  Sum: '<S117>/Subtract6'
         */
                FMS_DW.Integrator_DSTATE_cq += ((rtb_Square2 / FMS_ConstB.d_o - rtb_Divide_l_idx_2) * FMS_ConstB.Gain4_n3 * ((rtb_Divide_l_idx_1 - A) * 0.5F) - rtb_Saturation_l * 12.566371F) * 0.004F;
         ...
         *  SignalConversion: '<S17>/Signal Copy2'
         */
                FMS_MotionStatus_b(fabsf(FMS_U.Pilot_Cmd.stick_throttle) > FMS_PARAM.THROTTLE_DZ, fabsf(FMS_U.INS_Out.vd), &rtb_state_a, &FMS_DW.sf_MotionStatus_b);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl(FMS_U.INS_Out.h_R, &FMS_B.Merge_l, &FMS_DW.HoldControl_k2);
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_MoveControl(FMS_U.Pilot_Cmd.stick_throttle, &FMS_B.Merge_l, &FMS_ConstB.MoveControl_l, &FMS_DW.MoveControl_l);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl_kq(FMS_U.INS_Out.psi, &FMS_B.Merge_m, &FMS_DW.HoldControl_o);
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_MoveControl_b(FMS_U.Pilot_Cmd.stick_yaw, &FMS_B.Merge_m, &FMS_ConstB.MoveControl_cr, &FMS_DW.MoveControl_cr);
         ...
         *  Sum: '<S50>/Subtract'
         */
                rtb_Divide_l_idx_2 = (FMS_DW.Integrator1_DSTATE - 1.0F / (1.0F - FMS_PARAM.ROLL_DZ) * rtb_Square2 * FMS_PARAM.ROLL_PITCH_LIM) + rtb_Saturation_l;
         ...
         *  Sum: '<S52>/Subtract'
         */
                rtb_Rem_k = (sqrtf((8.0F * fabsf(rtb_Divide_l_idx_2) + FMS_ConstB.d) * FMS_ConstB.d) - FMS_ConstB.d) * 0.5F * rtb_Divide_l_idx_1 + rtb_Saturation_l;
         ...
         *  Sum: '<S52>/Subtract2'
         */
                rtb_Rem_k += (rtb_Divide_l_idx_1 - rtb_Divide_l_idx_2) * 0.5F * rtb_Square2;
         ...
         *  Sum: '<S51>/Subtract'
         */
                rtb_Saturation_l = (FMS_DW.Integrator1_DSTATE_o - 1.0F / (1.0F - FMS_PARAM.PITCH_DZ) * rtb_Square2 * -FMS_PARAM.ROLL_PITCH_LIM) + rtb_Rem_k;
         ...
         *  Sum: '<S53>/Subtract'
         */
                rtb_Square2 = (sqrtf((8.0F * fabsf(rtb_Saturation_l) + FMS_ConstB.d_c) * FMS_ConstB.d_c) - FMS_ConstB.d_c) * 0.5F * rtb_Square2 + rtb_Rem_k;
         ...
         *  Sum: '<S53>/Subtract2'
         */
                rtb_Square2 += (rtb_MathFunction_cr_idx_0 - rtb_Saturation_l) * 0.5F * rtb_Rem_k;
         ...
         *  Sum: '<S52>/Subtract6'
         */
                FMS_DW.Integrator_DSTATE += ((rtb_Divide - rtb_MathFunction_h_idx_0) * FMS_ConstB.Gain4 * ((A - rtb_Divide_l_idx_1) * 0.5F) - rtb_Divide_l_idx_2 * 12.566371F) * 0.004F;
         ...
         *  Sum: '<S53>/Subtract6'
         */
                FMS_DW.Integrator_DSTATE_b += ((rtb_Square2 / FMS_ConstB.d_c - rtb_Divide_l_idx_2) * FMS_ConstB.Gain4_m * ((rtb_Divide_l_idx_1 - A) * 0.5F) - rtb_Saturation_l * 12.566371F) * 0.004F;
         ...
         *  SignalConversion: '<S17>/Signal Copy2'
         */
                FMS_MotionStatus_b(fabsf(FMS_U.Pilot_Cmd.stick_throttle) > FMS_PARAM.THROTTLE_DZ, fabsf(FMS_U.INS_Out.vd), &rtb_state_a, &FMS_DW.sf_MotionStatus_i);
         ...
         *  SignalConversion: '<S17>/Signal Copy2'
         */
                rtb_FixPtRelationalOperator_n = ((fabsf(FMS_U.Pilot_Cmd.stick_pitch) > FMS_PARAM.PITCH_DZ) || (fabsf(FMS_U.Pilot_Cmd.stick_roll) > FMS_PARAM.ROLL_DZ));
         ...
         */
                ...
                if (FMS_DW.is_active_c16_FMS == 0U) {
                    ...
                    case FMS_IN_Brake_o:
                        ...
                        /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                        if ((sqrtf(FMS_U.INS_Out.vn * FMS_U.INS_Out.vn + FMS_U.INS_Out.ve * FMS_U.INS_Out.ve) <= 0.2) || (FMS_DW.temporalCounter_i1_i >= 625U)) {
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl_k(FMS_U.INS_Out.x_R, FMS_U.INS_Out.y_R, FMS_U.INS_Out.psi, FMS_B.Merge, &FMS_ConstB.HoldControl_at, &FMS_DW.HoldControl_at);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl(FMS_U.INS_Out.h_R, &FMS_B.Merge_k, &FMS_DW.HoldControl_p);
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_MoveControl(FMS_U.Pilot_Cmd.stick_throttle, &FMS_B.Merge_k, &FMS_ConstB.MoveControl_be, &FMS_DW.MoveControl_be);
         ...
         */
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_HoldControl_kq(FMS_U.INS_Out.psi, &FMS_B.Merge_d, &FMS_DW.HoldControl_e);
           ...
           */
                    /* Outputs for Atomic SubSystem: '<S2>/FMS_Input' */
                    FMS_MoveControl_b(FMS_U.Pilot_Cmd.stick_yaw, &FMS_B.Merge_d, &FMS_ConstB.MoveControl_mr, &FMS_DW.MoveControl_mr);
   ...
   */
    ...
    FMS_DW.DiscreteTimeIntegrator5_DSTATE[0] += (rtb_Multiply[0] - FMS_DW.DiscreteTimeIntegrator5_DSTATE[0]) * 2.0F * 0.004F;
    FMS_DW.DiscreteTimeIntegrator5_DSTATE[1] += (rtb_Multiply[1] - FMS_DW.DiscreteTimeIntegrator5_DSTATE[1]) * 2.0F * 0.004F;
    FMS_DW.DiscreteTimeIntegrator5_DSTATE[2] += (rtb_Multiply[2] - FMS_DW.DiscreteTimeIntegrator5_DSTATE[2]) * 2.0F * 0.004F;
   ...
   */
    ...
    FMS_DW.DiscreteTimeIntegrator5_DSTAT_d += ((real32_T)rtb_Divide_b - FMS_DW.DiscreteTimeIntegrator5_DSTAT_d) * 10.0F * 0.004F;
   ...
   */
    rtb_Square2 = (real32_T)FMS_DW.DiscreteTimeIntegrator1_DSTATE + (real32_T)FMS_EXPORT.period;
...
void FMS_init(void)
{
    ...
    /* block I/O */
    (void)memset(((void*)&FMS_B), 0, sizeof(B_FMS_T));
    ...
    /* states (dwork) */
    (void)memset((void*)&FMS_DW, 0, sizeof(DW_FMS_T));
