...
const ConstB_Plant_T Plant_ConstB = {
  1.9966471893352524,                  /* '<S118>/Sum' */
  0.0066943799901413165,               /* '<S118>/Multiply3' */
  0.99330562000985867,                 /* '<S118>/Sum4' */
  1.9966471868221032,                  /* '<S29>/Subtract1' */
  0.00669438499958795,                 /* '<S29>/Product1' */

  { 1.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 1.0F },/* '<S153>/Add' */

  { 0.0F, 0.0F, 1.0F },                /* '<S152>/Vector Concatenate3' */

  { 0.0F, 1.0F, 0.0F },                /* '<S151>/Vector Concatenate3' */
