...
extern void rt_mldivide_U1f3x3_U2f3x1_Yf3x1(const real32_T u0[9], const real32_T u1[3], real32_T y[3]);
extern void RandSrc_GZ_R(real32_T y[], const real32_T mean[], int32_T meanLen,
                         ...
                         int32_T nSamps);
extern void RandSrcInitState_GZ(const uint32_T seed[], uint32_T state[], int32_T nChans);
