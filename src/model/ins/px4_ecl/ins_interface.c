...
void ins_interface_init(void)
{
    ...
    fms_handle.fms_sub_node_t = mcn_subscribe(MCN_HUB(fms_output), NULL);
    control_handle.control_sub_node_t = mcn_subscribe(MCN_HUB(control_output), NULL);
