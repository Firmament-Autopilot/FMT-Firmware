...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(MAG_GAIN, 0.3),
    PARAM_UINT8(MAG_FLY_EN, 0),
    PARAM_FLOAT(BIAS_G_GAIN, 0.25),
    PARAM_FLOAT(GPS_HOR_Q_BIAS, 3.0),
    ...
    PARAM_UINT32(GPS_POS_DELAY, 100),
    PARAM_UINT32(GPS_VEL_DELAY, 100),
    PARAM_FLOAT(GPS_X_OFFSET, 0),
    PARAM_FLOAT(GPS_Y_OFFSET, 0),
    PARAM_FLOAT(GPS_Z_OFFSET, 0),
    PARAM_FLOAT(GPS_YAW_OFFSET, PI / 2.0f),
    PARAM_UINT8(GPS_YAW_EN, 0),
    PARAM_FLOAT(RTK_POS_GAIN, 0.4),
    PARAM_FLOAT(RTK_ALT_GAIN, 0.2),
    PARAM_FLOAT(RTK_VEL_GAIN, 1.5),
    PARAM_FLOAT(RTK_BIAS_A_GAIN, 0.5),
    PARAM_FLOAT(OPF_VEL_GAIN, 2),
    PARAM_FLOAT(OPF_BIAS_A_GAIN, 1),
    PARAM_UINT32(OPF_VEL_DELAY, 10),
    PARAM_FLOAT(OPF_FIX_GAIN, 0),
    PARAM_FLOAT(BARO_H_GAIN, 2),
    PARAM_FLOAT(BARO_VZ_GAIN, 1),
    PARAM_FLOAT(BARO_BIAS_AZ_GAIN, 0.2),
    PARAM_UINT32(BARO_H_DELAY, 10),
    PARAM_FLOAT(RF_H_GAIN, 3),
    PARAM_FLOAT(RF_VZ_GAIN, 5),
    PARAM_FLOAT(RF_BIAS_AZ_GAIN, 0.2),
    PARAM_UINT32(RF_H_DELAY, 10),
    PARAM_FLOAT(EXTPOS_POS_GAIN, 2.0),
    PARAM_FLOAT(EXTPOS_VEL_GAIN, 1.5),
    PARAM_FLOAT(EXTPOS_BIAS_A_GAIN, 0.1),
    PARAM_UINT32(EXTPOS_POS_DELAY, 20),
    PARAM_FLOAT(EXTPOS_PSI_OFS, 0.0),
    PARAM_UINT8(EXTPOS_USE_POS, 0),
    PARAM_UINT8(EXTPOS_USE_ALT, 0),
    PARAM_UINT8(EXTPOS_USE_ATT, 0),
    PARAM_UINT8(EXTPOS_USE_PSI, 0),
};
...
static void init_parameter(void)
{
    ...
    FMT_CHECK(param_link_variable(PARAM_GET(INS, OPF_FIX_GAIN), &INS_PARAM.OPF_FIX_GAIN));
    ...
    FMT_CHECK(param_link_variable(PARAM_GET(INS, EXTPOS_PSI_OFS), &INS_PARAM.EXTPOS_PSI_OFS));
}
