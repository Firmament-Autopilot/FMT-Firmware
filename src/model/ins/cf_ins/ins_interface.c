...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(GPS_HOR_Q_BIAS, 3.0, false),
    ...
    PARAM_FLOAT(GPS_POS_GAIN, 0.05, false),
    ...
    PARAM_FLOAT(EXTPOS_PSI_OFS, 0.0, false),
