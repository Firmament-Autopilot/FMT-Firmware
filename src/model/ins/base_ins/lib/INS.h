...
typedef struct {
  real_T DataTypeConversion;           /* '<S305>/Data Type Conversion' */
  real_T DataTypeConversion1;          /* '<S305>/Data Type Conversion1' */
  real_T Multiply2;                    /* '<S319>/Multiply2' */
  real_T Rm;                           /* '<S319>/Product3' */
  real32_T Divide;                     /* '<S292>/Divide' */
...
typedef struct {
  ...
  real32_T DiscreteTimeIntegrator_DSTATE;/* '<S335>/Discrete-Time Integrator' */
  real32_T DiscreteTimeIntegrator1_DSTATE;/* '<S335>/Discrete-Time Integrator1' */
  real32_T DiscreteTimeIntegrator1_DSTAT_m;/* '<S318>/Discrete-Time Integrator1' */
  real32_T DiscreteTimeIntegrator_DSTATE_l;/* '<S318>/Discrete-Time Integrator' */
  real32_T Delay_DSTATE_d;             /* '<S292>/Delay' */
  ...
  int32_T UnitDelay_DSTATE;            /* '<S314>/Unit Delay' */
  uint32_T DelayInput1_DSTATE;         /* '<S342>/Delay Input1' */
  uint32_T DiscreteTimeIntegrator_DSTAT_lg;/* '<S328>/Discrete-Time Integrator' */
  uint32_T DelayInput1_DSTATE_h;       /* '<S323>/Delay Input1' */
  uint32_T DiscreteTimeIntegrator_DSTAT_lp;/* '<S321>/Discrete-Time Integrator' */
  uint32_T DelayInput1_DSTATE_i;       /* '<S317>/Delay Input1' */
  uint32_T DiscreteTimeIntegrator_DSTATE_i;/* '<S308>/Discrete-Time Integrator' */
  uint32_T DelayInput1_DSTATE_g;       /* '<S295>/Delay Input1' */
  uint32_T DelayInput1_DSTATE_c;       /* '<S298>/Delay Input1' */
  uint32_T DiscreteTimeIntegrator_DSTAT_nm;/* '<S291>/Discrete-Time Integrator' */
  uint32_T Delay_DSTATE_f;             /* '<S293>/Delay' */
  uint32_T Delay1_DSTATE_i;            /* '<S292>/Delay1' */
  ...
  int8_T DiscreteTimeIntegrator_PrevRese;/* '<S335>/Discrete-Time Integrator' */
  int8_T DiscreteTimeIntegrator1_PrevRes;/* '<S335>/Discrete-Time Integrator1' */
  int8_T DiscreteTimeIntegrator1_PrevR_j;/* '<S318>/Discrete-Time Integrator1' */
  int8_T DiscreteTimeIntegrator_PrevRe_j;/* '<S318>/Discrete-Time Integrator' */
  ...
  uint8_T DiscreteTimeIntegrator1_IC_LOAD;/* '<S335>/Discrete-Time Integrator1' */
  uint8_T DiscreteTimeIntegrator1_IC_LO_e;/* '<S318>/Discrete-Time Integrator1' */
  ...
  boolean_T Reference_Height_MODE;     /* '<S290>/Reference_Height' */
...
typedef struct {
  ZCSigState WGS84_Model_Trig_ZCE;     /* '<S285>/WGS84_Model' */
...
struct Parameters_INS_T_ {
  struct_Gsh1YUlqR57cYRpVuxG74E INS_CONST;/* Variable: INS_CONST
                                           * Referenced by:
                                           *   '<S331>/Declination_Lookup_Table'
                                           *   '<S331>/Inclination_Lookup_Table'
                                           *   '<S331>/Magnitude_Lookup_Table'
                                           *   '<S69>/Constant'
                                           *   '<S221>/Constant1'
                                           */
  real_T WMM_LUT_resolution;           /* Mask Parameter: WMM_LUT_resolution
                                        * Referenced by: '<S331>/rad_to_index'
                                        */
  ...
  real32_T Sensor_Valid_max_pressure;  /* Mask Parameter: Sensor_Valid_max_pressure
                                        * Referenced by: '<S299>/Upper Limit'
                                        */
  ...
  real32_T Sensor_Valid_min_pressure;  /* Mask Parameter: Sensor_Valid_min_pressure
                                        * Referenced by: '<S299>/Lower Limit'
                                        */
  ...
  uint32_T IntervalTest3_lowlimit;     /* Mask Parameter: IntervalTest3_lowlimit
                                        * Referenced by: '<S296>/Lower Limit'
                                        */
  ...
  uint32_T IntervalTest3_uplimit;      /* Mask Parameter: IntervalTest3_uplimit
                                        * Referenced by: '<S296>/Upper Limit'
                                        */
  ...
  real_T lon_0_rad_Y0;                 /* Expression: 0
                                        * Referenced by: '<S305>/lon_0_rad'
                                        */
  real_T lat_0_rad_Y0;                 /* Expression: 0
                                        * Referenced by: '<S305>/lat_0_rad'
                                        */
  real_T dx_dlat_Y0;                   /* Expression: 1
                                        * Referenced by: '<S305>/dx_dlat'
                                        */
  real_T dy_dlon_Y0;                   /* Expression: 1
                                        * Referenced by: '<S305>/dy_dlon'
                                        */
  real_T dz_dh_Y0;                     /* Expression: 1
                                        * Referenced by: '<S305>/dz_dh'
                                        */
  ...
  real32_T AirDensity_15C_Value;       /* Computed Parameter: AirDensity_15C_Value
                                        * Referenced by: '<S288>/AirDensity_15C'
                                        */
  real32_T Gain_Gain_jo;               /* Computed Parameter: Gain_Gain_jo
                                        * Referenced by: '<S288>/Gain'
                                        */
  real32_T h_R_m_Y0;                   /* Computed Parameter: h_R_m_Y0
                                        * Referenced by: '<S292>/h_R_m'
                                        */
  ...
  real32_T default_mag_quality_Value;  /* Computed Parameter: default_mag_quality_Value
                                        * Referenced by: '<S329>/default_mag_quality'
                                        */
  ...
  real32_T Gauss_to_uT_Gain;           /* Computed Parameter: Gauss_to_uT_Gain
                                        * Referenced by: '<S287>/Gauss_to_uT'
                                        */
  ...
  real32_T Nominal_Magnitude_Value;    /* Computed Parameter: Nominal_Magnitude_Value
                                        * Referenced by: '<S334>/Nominal_Magnitude'
                                        */
  ...
  real32_T DiscreteTimeIntegrator1_gainv_m;/* Computed Parameter: DiscreteTimeIntegrator1_gainv_m
                                            * Referenced by: '<S335>/Discrete-Time Integrator1'
                                            */
 ...
 * '<S283>' : 'INS/Sensor_PreProcess/AirSpeed_Process'
 * '<S284>' : 'INS/Sensor_PreProcess/Baro_Process'
 * '<S285>' : 'INS/Sensor_PreProcess/GPS_PreProcess'
 * '<S286>' : 'INS/Sensor_PreProcess/IMU_PreProcess'
 * '<S287>' : 'INS/Sensor_PreProcess/MAG_PreProcess'
 * '<S288>' : 'INS/Sensor_PreProcess/AirSpeed_Process/Calculate_IAS'
 * '<S289>' : 'INS/Sensor_PreProcess/Baro_Process/Pressure_Height'
 * '<S290>' : 'INS/Sensor_PreProcess/Baro_Process/Relative_Height'
 * '<S291>' : 'INS/Sensor_PreProcess/Baro_Process/Sensor_Valid'
 * '<S292>' : 'INS/Sensor_PreProcess/Baro_Process/Relative_Height/Reference_Height'
 * '<S293>' : 'INS/Sensor_PreProcess/Baro_Process/Relative_Height/Sampling'
 * '<S294>' : 'INS/Sensor_PreProcess/Baro_Process/Relative_Height/Sampling/Compare To Constant'
 * '<S295>' : 'INS/Sensor_PreProcess/Baro_Process/Relative_Height/Sampling/Detect Change'
 * '<S296>' : 'INS/Sensor_PreProcess/Baro_Process/Relative_Height/Sampling/Interval Test3'
 * '<S297>' : 'INS/Sensor_PreProcess/Baro_Process/Sensor_Valid/Compare To Constant4'
 * '<S298>' : 'INS/Sensor_PreProcess/Baro_Process/Sensor_Valid/Detect Change'
 * '<S299>' : 'INS/Sensor_PreProcess/Baro_Process/Sensor_Valid/Interval Test1'
 * '<S300>' : 'INS/Sensor_PreProcess/Baro_Process/Sensor_Valid/Interval Test2'
 * '<S301>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Compare To Constant'
 * '<S302>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Compare To Constant1'
 * '<S303>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Data_Scalling'
 * '<S304>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality'
 * '<S305>' : 'INS/Sensor_PreProcess/GPS_PreProcess/WGS84_Model'
 * '<S306>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/Compare To Constant2'
 * '<S307>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/GPS_Status'
 * '<S308>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/check_timeout'
 * '<S309>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/horizontal_quality'
 * '<S310>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/speed_acc'
 * '<S311>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/vertical_quality'
 * '<S312>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/GPS_Status/Compare To Constant'
 * '<S313>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/GPS_Status/Compare To Constant1'
 * '<S314>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/GPS_Status/Ready'
 * '<S315>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/GPS_Status/Ready/valid_samples'
 * '<S316>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/check_timeout/Compare To Constant4'
 * '<S317>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/check_timeout/Detect Change'
 * '<S318>' : 'INS/Sensor_PreProcess/GPS_PreProcess/Status_Quality/speed_acc/Second Order LPF'
 * '<S319>' : 'INS/Sensor_PreProcess/GPS_PreProcess/WGS84_Model/LAT2FLAT Curve'
 * '<S320>' : 'INS/Sensor_PreProcess/IMU_PreProcess/Data_Select'
 * '<S321>' : 'INS/Sensor_PreProcess/IMU_PreProcess/Sensor_Valid'
 * '<S322>' : 'INS/Sensor_PreProcess/IMU_PreProcess/Sensor_Valid/Compare To Constant4'
 * '<S323>' : 'INS/Sensor_PreProcess/IMU_PreProcess/Sensor_Valid/Detect Change'
 * '<S324>' : 'INS/Sensor_PreProcess/IMU_PreProcess/Sensor_Valid/Interval Test1'
 * '<S325>' : 'INS/Sensor_PreProcess/IMU_PreProcess/Sensor_Valid/Interval Test3'
 * '<S326>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Bus_Select'
 * '<S327>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process'
 * '<S328>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Sensor_Valid'
 * '<S329>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/Mag_Quality_Estimate'
 * '<S330>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/WMM_Compensation'
 * '<S331>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/WMM_LUT'
 * '<S332>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/Mag_Quality_Estimate/Mag_Quality'
 * '<S333>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/Mag_Quality_Estimate/Mag_Quality/Inclination_Quality_Estimate'
 * '<S334>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/Mag_Quality_Estimate/Mag_Quality/Intensity_Quality_Estimate'
 * '<S335>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/Mag_Quality_Estimate/Mag_Quality/Second Order LPF'
 * '<S336>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/Mag_Quality_Estimate/Mag_Quality/Inclination_Quality_Estimate/Vector Modulus'
 * '<S337>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/Mag_Quality_Estimate/Mag_Quality/Intensity_Quality_Estimate/Vector Modulus'
 * '<S338>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/WMM_Compensation/Rotation Matrix Z'
 * '<S339>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/WMM_Compensation/Vector Normalize'
 * '<S340>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Mag_Data_Process/WMM_Compensation/safe_divide'
 * '<S341>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Sensor_Valid/Compare To Constant4'
 * '<S342>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Sensor_Valid/Detect Change'
 * '<S343>' : 'INS/Sensor_PreProcess/MAG_PreProcess/Sensor_Valid/Interval Test1'
 */
