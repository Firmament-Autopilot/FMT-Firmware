...
struct_biZzOMrg0u3lxrb7POOubF CONTROL_EXPORT = {
    ...
    { 66, 97, 115, 101, 32, 67, 111, 110, 116, 114, 111, 108, 108, 101, 114, 32, 118, 48, 46, 50, 46, 49, 0 }
...
void Controller_step(void)
{
   ...
   *  Inport: '<Root>/FMS_Out'
   */
    if ((Controller_U.FMS_Out.reset != 0) || (Controller_DW.DiscreteTimeIntegrator_PrevRese != 0)) {
   ...
   *  Inport: '<Root>/FMS_Out'
   */
    if ((Controller_U.FMS_Out.reset != 0) || (Controller_DW.DiscreteTimeIntegrator1_PrevRes != 0)) {
   ...
   *  Sum: '<S57>/Sum5'
   */
    rtb_Gain_am = (rtb_Gain - Controller_DW.DiscreteTimeIntegrator1_DSTATE) * 62.831852F;
   ...
   */
    for (i = 0; i < 3; i++) {
        rtb_VectorConcatenate_0[i] = rtb_VectorConcatenate[i + 3] * Controller_U.INS_Out.ve + rtb_VectorConcatenate[i] * Controller_U.INS_Out.vn;
    }
   ...
   */
    rtb_uv_error_C_mPs_idx_0 = Controller_DW.Integrator1_DSTATE_g[0] - rtb_VectorConcatenate_0[0];
    rtb_uv_error_C_mPs_idx_1 = Controller_DW.Integrator1_DSTATE_g[1] - rtb_VectorConcatenate_0[1];

    /* DiscreteIntegrator: '<S42>/Discrete-Time Integrator' incorporates:
   *  Inport: '<Root>/FMS_Out'
   */
    if ((Controller_U.FMS_Out.reset != 0) || (Controller_DW.DiscreteTimeIntegrator_PrevRe_e != 0)) {
        Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] = Controller_ConstB.Constant_g;
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] >= CONTROL_PARAM.VEL_XY_I_MAX) {
            Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] = CONTROL_PARAM.VEL_XY_I_MAX;
        } else {
            if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] <= CONTROL_PARAM.VEL_XY_I_MIN) {
                Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] = CONTROL_PARAM.VEL_XY_I_MIN;
            }
        }

        Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] = Controller_ConstB.Constant_g;
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] >= CONTROL_PARAM.VEL_XY_I_MAX) {
            Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] = CONTROL_PARAM.VEL_XY_I_MAX;
        } else {
            if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] <= CONTROL_PARAM.VEL_XY_I_MIN) {
                Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] = CONTROL_PARAM.VEL_XY_I_MIN;
            }
        }
    }
   ...
   *  Inport: '<Root>/FMS_Out'
   */
    if ((Controller_U.FMS_Out.reset != 0) || (Controller_DW.DiscreteTimeIntegrator1_PrevR_a != 0)) {
   ...
   *  Sum: '<S44>/Sum5'
   */
    rtb_Gain_j_idx_0 = (rtb_uv_error_C_mPs_idx_0 - Controller_DW.DiscreteTimeIntegrator1_DSTAT_m[0]) * 62.831852F;
    rtb_Gain_j_idx_1 = (rtb_uv_error_C_mPs_idx_1 - Controller_DW.DiscreteTimeIntegrator1_DSTAT_m[1]) * 62.831852F;
   ...
   */
     ...
     */
        if ((Controller_U.FMS_Out.ctrl_mode == 3) || (Controller_U.FMS_Out.ctrl_mode == 4)) {
       ...
       *  Sum: '<S35>/Add'
       */
            rtb_Saturation_nc = (CONTROL_PARAM.VEL_XY_P * rtb_uv_error_C_mPs_idx_0 + Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0]) + rtb_DiscreteTimeIntegrator1_b_i;
       ...
       *  Product: '<S43>/Multiply'
       */
            rtb_DiscreteTimeIntegrator1_b_i += CONTROL_PARAM.VEL_XY_P * rtb_uv_error_C_mPs_idx_1 + Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1];
     ...
     *  Sum: '<S30>/Subtract'
     */
        if ((rtb_DiscreteTimeIntegrator1_b_i <= rtb_Multiply3_c) && (rtb_DiscreteTimeIntegrator1_b_i >= -rtb_Multiply3_c)) {
            rtb_DiscreteTimeIntegrator1_b_i *= CONTROL_PARAM.ROLL_P;
        } else {
            rtb_DiscreteTimeIntegrator1_b_i = sqrtf((rtb_Cos * rtb_DiscreteTimeIntegrator1_b_i - 0.5F * rtb_Multiply3_c) * Controller_ConstB.Gain) * rtb_Cos;
        }
     ...
     *  Product: '<S30>/Divide1'
     */
        rtb_DiscreteTimeIntegrator1_b_i = rtb_Atan_idx_1 - Controller_U.INS_Out.theta;
     ...
     */
        ...
        rtb_DiscreteTimeIntegrator1_b_i = rtb_Saturation1_i_idx_0 - arm_sin_f32(Controller_U.INS_Out.theta) * rtb_Saturation_m;
   ...
   *  Inport: '<Root>/FMS_Out'
   */
    if ((Controller_U.FMS_Out.reset != 0) || (Controller_DW.DiscreteTimeIntegrator_PrevRe_g != 0)) {
        Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] = Controller_ConstB.Constant_n[0];
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] >= CONTROL_PARAM.RATE_I_MAX) {
            Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] = CONTROL_PARAM.RATE_I_MAX;
        } else {
            if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] <= CONTROL_PARAM.RATE_I_MIN) {
                Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] = CONTROL_PARAM.RATE_I_MIN;
            }
        }

        Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] = Controller_ConstB.Constant_n[1];
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] >= CONTROL_PARAM.RATE_I_MAX) {
            Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] = CONTROL_PARAM.RATE_I_MAX;
        } else {
            if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] <= CONTROL_PARAM.RATE_I_MIN) {
                Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] = CONTROL_PARAM.RATE_I_MIN;
            }
        }

        Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] = Controller_ConstB.Constant_n[2];
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] >= CONTROL_PARAM.RATE_I_MAX) {
            Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] = CONTROL_PARAM.RATE_I_MAX;
        } else {
            if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] <= CONTROL_PARAM.RATE_I_MIN) {
   ...
   *  Inport: '<Root>/FMS_Out'
   */
    if ((Controller_U.FMS_Out.reset != 0) || (Controller_DW.DiscreteTimeIntegrator1_PrevR_i != 0)) {
   ...
   *  Sum: '<S22>/Sum5'
   */
    rtb_DiscreteTimeIntegrator1_b_i = (Controller_DW.DiscreteTimeIntegrator5_DSTATE[0] - Controller_DW.DiscreteTimeIntegrator1_DSTAT_o[0]) * 188.49556F;
    rtb_Multiply3_c = (Controller_DW.DiscreteTimeIntegrator5_DSTATE[1] - Controller_DW.DiscreteTimeIntegrator1_DSTAT_o[1]) * 188.49556F;
    rtb_Saturation_m = (Controller_DW.DiscreteTimeIntegrator5_DSTATE[2] - Controller_DW.DiscreteTimeIntegrator1_DSTAT_o[2]) * 188.49556F;
   ...
   */
     ...
     *  Sum: '<S46>/Sum1'
     */
        if ((Controller_U.FMS_Out.ctrl_mode == 1) || (Controller_U.FMS_Out.ctrl_mode == 2) || (Controller_U.FMS_Out.ctrl_mode == 3)) {
       ...
       */
            rtb_Saturation_nc = arm_cos_f32(Controller_U.INS_Out.phi) * arm_cos_f32(Controller_U.INS_Out.theta);
       ...
       *  Sum: '<S51>/Add'
       */
            rtb_Saturation_nc = ((CONTROL_PARAM.VEL_Z_P * rtb_Gain + Controller_DW.DiscreteTimeIntegrator_DSTATE) + rtb_Saturation_nc) * rtb_Saturation1_i_idx_0 * rtb_a_n;
     ...
     *  Sum: '<S16>/Add'
     */
        rtb_a_n = (CONTROL_PARAM.ROLL_RATE_P * Controller_DW.DiscreteTimeIntegrator5_DSTATE[0] + Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0]) + rtb_Saturation_d_idx_0;
        if (rtb_a_n > 1.0F) {
            rtb_a_n = 1.0F;
        } else {
            if (rtb_a_n < -1.0F) {
        ...
        rtb_Saturation_d_idx_0 = (CONTROL_PARAM.PITCH_RATE_P * Controller_DW.DiscreteTimeIntegrator5_DSTATE[1] + Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1]) + rtb_Saturation_d_idx_1;
        ...
        rtb_Saturation_d_idx_1 = (CONTROL_PARAM.YAW_RATE_P * Controller_DW.DiscreteTimeIntegrator5_DSTATE[2] + Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2]) + rtb_Subtract3_i;
       ...
       *  Sum: '<S6>/Add'
       */
            rtb_Saturation_nc = fmodf(floorf(1000.0F * (Controller_ConstP.X_Frame_Effective_Matrix_Value[i + 8] * rtb_Saturation_d_idx_1 + (Controller_ConstP.X_Frame_Effective_Matrix_Value[i + 4] * rtb_Saturation_d_idx_0 + Controller_ConstP.X_Frame_Effective_Matrix_Value[i] * rtb_a_n))),
                                      65536.0F);
            u0 = (uint16_T)((uint32_T)(rtb_Saturation_nc < 0.0F ? (int32_T)(uint16_T)
                                               - (int16_T)(uint16_T)-rtb_Saturation_nc
                                                                : (int32_T)(uint16_T)
                                                                    rtb_Saturation_nc)
       ...
       */
        ...
        for (i = 0; i < 16; i++) {
            Controller_Y.Control_Out.actuator_cmd[i] = Controller_U.FMS_Out.actuator_cmd[i];
        }
    }
   ...
   *  DiscreteIntegrator: '<S18>/Discrete-Time Integrator5'
   */
    rtb_Saturation_d_idx_0 = CONTROL_PARAM.ROLL_RATE_I * Controller_DW.DiscreteTimeIntegrator5_DSTATE[0];
    rtb_Saturation_d_idx_1 = CONTROL_PARAM.PITCH_RATE_I * Controller_DW.DiscreteTimeIntegrator5_DSTATE[1];
    rtb_Saturation_d_idx_2 = CONTROL_PARAM.YAW_RATE_I * Controller_DW.DiscreteTimeIntegrator5_DSTATE[2];
   ...
   *  Sum: '<S37>/Subtract'
   */
    rtb_Saturation1_i_idx_0 = (Controller_DW.Integrator1_DSTATE_g[0] - Controller_U.FMS_Out.u_cmd) + rtb_Atan_idx_0;
    rtb_Saturation1_i_idx_1 = (Controller_DW.Integrator1_DSTATE_g[1] - Controller_U.FMS_Out.v_cmd) + rtb_Atan_idx_1;
   ...
   *  Sum: '<S40>/Subtract'
   */
    rtb_Saturation_nc = (sqrtf((8.0F * fabsf(rtb_Saturation1_i_idx_0) + Controller_ConstB.d) * Controller_ConstB.d) - Controller_ConstB.d) * 0.5F * rtb_Saturation_nc + rtb_Atan_idx_0;
   ...
   *  Sum: '<S40>/Subtract2'
   */
    rtb_Saturation1_i_idx_0 = ((rtb_Saturation1_i_idx_0 - rtb_Saturation_nc) + rtb_Atan_idx_0) * ((rtb_Subtract3_i - rtb_a_n) * 0.5F) + rtb_Saturation_nc;
   ...
   *  Sum: '<S40>/Subtract'
   */
    rtb_Saturation_nc = (sqrtf((8.0F * fabsf(rtb_Saturation1_i_idx_1) + Controller_ConstB.d) * Controller_ConstB.d) - Controller_ConstB.d) * 0.5F * rtb_Saturation_nc + rtb_Atan_idx_1;
   ...
   *  Sum: '<S40>/Subtract2'
   */
    rtb_Saturation_nc += ((rtb_Saturation1_i_idx_1 - rtb_Saturation_nc) + rtb_Atan_idx_1) * ((rtb_Subtract3_i - rtb_a_n) * 0.5F);

    /* Outport: '<Root>/Control_Out' incorporates:
   *  DiscreteIntegrator: '<S4>/Discrete-Time Integrator'
   */
    Controller_Y.Control_Out.timestamp = Controller_DW.DiscreteTimeIntegrator_DSTATE_n;
   ...
   *  Sum: '<S52>/Subtract'
   */
    rtb_Atan_idx_1 = (Controller_DW.Integrator1_DSTATE - Controller_U.FMS_Out.w_cmd) + rtb_Subtract3_i;
   ...
   *  Sum: '<S53>/Subtract'
   */
    rtb_a_n = (sqrtf((8.0F * fabsf(rtb_Atan_idx_1) + Controller_ConstB.d_n) * Controller_ConstB.d_n) - Controller_ConstB.d_n) * 0.5F * rtb_a_n + rtb_Subtract3_i;
   ...
   */
    Controller_DW.DiscreteTimeIntegrator_DSTATE += CONTROL_PARAM.VEL_Z_I * rtb_Gain * 0.002F;
    if (Controller_DW.DiscreteTimeIntegrator_DSTATE >= CONTROL_PARAM.VEL_Z_I_MAX) {
        Controller_DW.DiscreteTimeIntegrator_DSTATE = CONTROL_PARAM.VEL_Z_I_MAX;
    } else {
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE <= CONTROL_PARAM.VEL_Z_I_MIN) {
    ...
    Controller_DW.DiscreteTimeIntegrator_PrevRese = (int8_T)(Controller_U.FMS_Out.reset > 0);
   ...
   */
    ...
    Controller_DW.DiscreteTimeIntegrator1_PrevRes = (int8_T)(Controller_U.FMS_Out.reset > 0);

    /* Update for DiscreteIntegrator: '<S42>/Discrete-Time Integrator' incorporates:
   *  Inport: '<Root>/FMS_Out'
   */
    Controller_DW.DiscreteTimeIntegrator_PrevRe_e = (int8_T)(Controller_U.FMS_Out.reset > 0);

    /* Update for DiscreteIntegrator: '<S37>/Integrator1' incorporates:
   *  DiscreteIntegrator: '<S37>/Integrator'
   */
    Controller_DW.Integrator1_DSTATE_g[0] += 0.002F * Controller_DW.Integrator_DSTATE[0];

    /* Update for DiscreteIntegrator: '<S42>/Discrete-Time Integrator' incorporates:
   *  Constant: '<S42>/ki'
   *  Product: '<S42>/Multiply'
   */
    Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] += CONTROL_PARAM.VEL_XY_I * rtb_uv_error_C_mPs_idx_0 * 0.002F;
    if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] >= CONTROL_PARAM.VEL_XY_I_MAX) {
        Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] = CONTROL_PARAM.VEL_XY_I_MAX;
    } else {
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] <= CONTROL_PARAM.VEL_XY_I_MIN) {
   ...
   *  DiscreteIntegrator: '<S37>/Integrator'
   */
    Controller_DW.Integrator1_DSTATE_g[1] += 0.002F * Controller_DW.Integrator_DSTATE[1];

    /* Update for DiscreteIntegrator: '<S42>/Discrete-Time Integrator' incorporates:
   *  Constant: '<S42>/ki'
   *  Product: '<S42>/Multiply'
   */
    Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] += CONTROL_PARAM.VEL_XY_I * rtb_uv_error_C_mPs_idx_1 * 0.002F;
    if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] >= CONTROL_PARAM.VEL_XY_I_MAX) {
        Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] = CONTROL_PARAM.VEL_XY_I_MAX;
    } else {
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] <= CONTROL_PARAM.VEL_XY_I_MIN) {
   ...
   */
    ...
    Controller_DW.DiscreteTimeIntegrator1_PrevR_a = (int8_T)(Controller_U.FMS_Out.reset > 0);
   ...
   *  Inport: '<Root>/FMS_Out'
   */
    Controller_DW.DiscreteTimeIntegrator_PrevRe_g = (int8_T)(Controller_U.FMS_Out.reset > 0);

    /* Update for DiscreteIntegrator: '<S18>/Discrete-Time Integrator5' incorporates:
   *  Gain: '<S18>/Gain'
   *  Sum: '<S18>/Sum5'
   */
    Controller_DW.DiscreteTimeIntegrator5_DSTATE[0] += (rtb_Cos - Controller_DW.DiscreteTimeIntegrator5_DSTATE[0]) * 314.159271F * 0.002F;

    /* Update for DiscreteIntegrator: '<S20>/Discrete-Time Integrator' */
    Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] += 0.002F * rtb_Saturation_d_idx_0;
    if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] >= CONTROL_PARAM.RATE_I_MAX) {
        Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] = CONTROL_PARAM.RATE_I_MAX;
    } else {
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] <= CONTROL_PARAM.RATE_I_MIN) {
    ...
    Controller_DW.DiscreteTimeIntegrator1_DSTAT_o[0] += 0.002F * rtb_DiscreteTimeIntegrator1_b_i;

    /* Update for DiscreteIntegrator: '<S18>/Discrete-Time Integrator5' incorporates:
   *  Gain: '<S18>/Gain'
   *  Sum: '<S18>/Sum5'
   */
    Controller_DW.DiscreteTimeIntegrator5_DSTATE[1] += (rtb_Cos1 - Controller_DW.DiscreteTimeIntegrator5_DSTATE[1]) * 314.159271F * 0.002F;

    /* Update for DiscreteIntegrator: '<S20>/Discrete-Time Integrator' */
    Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] += 0.002F * rtb_Saturation_d_idx_1;
    if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] >= CONTROL_PARAM.RATE_I_MAX) {
        Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] = CONTROL_PARAM.RATE_I_MAX;
    } else {
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] <= CONTROL_PARAM.RATE_I_MIN) {
   ...
   *  Sum: '<S18>/Sum5'
   */
    Controller_DW.DiscreteTimeIntegrator5_DSTATE[2] += (rtb_Multiply4_b - Controller_DW.DiscreteTimeIntegrator5_DSTATE[2]) * 314.159271F * 0.002F;

    /* Update for DiscreteIntegrator: '<S20>/Discrete-Time Integrator' */
    Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] += 0.002F * rtb_Saturation_d_idx_2;
    if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] >= CONTROL_PARAM.RATE_I_MAX) {
        Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] = CONTROL_PARAM.RATE_I_MAX;
    } else {
        if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] <= CONTROL_PARAM.RATE_I_MIN) {
   ...
   */
    ...
    Controller_DW.DiscreteTimeIntegrator1_PrevR_i = (int8_T)(Controller_U.FMS_Out.reset > 0);
   ...
   *  Sum: '<S40>/Subtract6'
   */
    Controller_DW.Integrator_DSTATE[0] += ((rtb_Saturation1_i_idx_0 / Controller_ConstB.d - rtb_Gain_am) * Controller_ConstB.Gain4 * ((rtb_Subtract3_i - rtb_Gain) * 0.5F) - rtb_uv_error_C_mPs_idx_0 * 58.836F) * 0.002F;
   ...
   *  Sum: '<S40>/Subtract6'
   */
    Controller_DW.Integrator_DSTATE[1] += ((rtb_Saturation_nc / Controller_ConstB.d - rtb_Gain_am) * Controller_ConstB.Gain4 * ((rtb_Subtract3_i - rtb_Gain) * 0.5F) - rtb_uv_error_C_mPs_idx_0 * 58.836F) * 0.002F;
   ...
   *  Sum: '<S53>/Subtract6'
   */
    Controller_DW.Integrator_DSTATE_p += ((rtb_a_n / Controller_ConstB.d_n - rtb_uv_error_C_mPs_idx_0) * Controller_ConstB.Gain4_k * ((rtb_Subtract3_i - rtb_Gain) * 0.5F) - rtb_Gain_am * 78.448F) * 0.002F;
}
...
void Controller_init(void)
{
    ...
    /* states (dwork) */
    (void)memset((void*)&Controller_DW, 0, sizeof(DW_Controller_T));
