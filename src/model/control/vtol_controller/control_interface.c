...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(MC_ROLL_RATE_P, 0.045, false),
    PARAM_FLOAT(MC_PITCH_RATE_P, 0.045, false),
    PARAM_FLOAT(MC_YAW_RATE_P, 0.15, false),
    PARAM_FLOAT(MC_ROLL_RATE_I, 0.05, false),
    PARAM_FLOAT(MC_PITCH_RATE_I, 0.05, false),
    PARAM_FLOAT(MC_YAW_RATE_I, 0.15, false),
    PARAM_FLOAT(MC_ROLL_RATE_D, 0.0015, false),
    PARAM_FLOAT(MC_PITCH_RATE_D, 0.0015, false),
    PARAM_FLOAT(MC_YAW_RATE_D, 0.001, false),
