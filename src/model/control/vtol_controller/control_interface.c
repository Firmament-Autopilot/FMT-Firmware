...
static param_t __param_list[] = {
    PARAM_UINT8_RO(AIRFRAME, AIRFRAME),
    PARAM_FLOAT(MC_VEL_XY_P, 1.4),
    PARAM_FLOAT(MC_VEL_XY_I, 0.2),
    PARAM_FLOAT(MC_VEL_XY_D, 0.05),
    PARAM_FLOAT(MC_VEL_Z_P, 0.5),
    PARAM_FLOAT(MC_VEL_Z_I, 0.12),
    PARAM_FLOAT(MC_VEL_Z_D, 0.0),
    PARAM_FLOAT(MC_VEL_XY_I_MIN, -1),
    PARAM_FLOAT(MC_VEL_XY_I_MAX, 1),
    PARAM_FLOAT(MC_VEL_XY_D_MIN, -1),
    PARAM_FLOAT(MC_VEL_XY_D_MAX, 1),
    PARAM_FLOAT(MC_VEL_Z_I_MIN, -0.2),
    PARAM_FLOAT(MC_VEL_Z_I_MAX, 0.2),
    PARAM_FLOAT(MC_VEL_Z_D_MIN, -0.1),
    PARAM_FLOAT(MC_VEL_Z_D_MAX, 0.1),
    PARAM_FLOAT(MC_ROLL_P, 7),
    PARAM_FLOAT(MC_PITCH_P, 5),
    PARAM_FLOAT(MC_ROLL_PITCH_CMD_LIM, PI / 6),
    PARAM_FLOAT(MC_ROLL_RATE_P, 0.18),
    PARAM_FLOAT(MC_PITCH_RATE_P, 0.18),
    PARAM_FLOAT(MC_YAW_RATE_P, 0.6),
    PARAM_FLOAT(MC_ROLL_RATE_I, 0.15),
    PARAM_FLOAT(MC_PITCH_RATE_I, 0.15),
    PARAM_FLOAT(MC_YAW_RATE_I, 0.2),
    PARAM_FLOAT(MC_ROLL_RATE_D, 0.006),
    PARAM_FLOAT(MC_PITCH_RATE_D, 0.009),
    PARAM_FLOAT(MC_YAW_RATE_D, 0.02),
    PARAM_FLOAT(MC_ROLL_RATE_FF, 0.0),
    PARAM_FLOAT(MC_PITCH_RATE_FF, 0.0),
    PARAM_FLOAT(MC_RATE_I_MIN, -0.2),
    PARAM_FLOAT(MC_RATE_I_MAX, 0.2),
    PARAM_FLOAT(MC_RATE_D_MIN, -0.2),
    PARAM_FLOAT(MC_RATE_D_MAX, 0.2),
    PARAM_FLOAT(MC_P_Q_CMD_LIM, PI / 2),
    PARAM_FLOAT(MC_R_CMD_LIM, PI / 3),
    PARAM_FLOAT(MC_HOVER_THRO, 0.5),
    PARAM_UINT16(MC_OUT_MAX, 2000),
    PARAM_UINT16(MC_OUT_MIN, 1000),

    PARAM_FLOAT(FW_ROLL_P, 5.0),
    PARAM_FLOAT(FW_PITCH_P, 5.0),
    PARAM_FLOAT(FW_ROLL_PITCH_CMD_LIM, PI / 4),
    PARAM_FLOAT(FW_ROLL_RATE_P, 0.1),
    PARAM_FLOAT(FW_PITCH_RATE_P, 0.15),
    PARAM_FLOAT(FW_YAW_RATE_P, 0.15),
    PARAM_FLOAT(FW_ROLL_RATE_I, 0.1),
    PARAM_FLOAT(FW_PITCH_RATE_I, 0.1),
    PARAM_FLOAT(FW_YAW_RATE_I, 0.2),
    PARAM_FLOAT(FW_RATE_I_MIN, -0.4),
    PARAM_FLOAT(FW_RATE_I_MAX, 0.4),
    PARAM_FLOAT(FW_P_Q_CMD_LIM, PI / 3),
    PARAM_FLOAT(FW_R_CMD_LIM, PI / 6),
    PARAM_FLOAT(FW_AIRSPEED_TRIM, 17.0),
    PARAM_FLOAT(FW_FF, 0.2),
    PARAM_FLOAT(FW_ROLL_EFFC, 1.0),
    PARAM_FLOAT(FW_PITCH_EFFC, 1.0),
    PARAM_FLOAT(FW_YAW_EFFC, 1.0),
    PARAM_FLOAT(FW_PITCH_OFFSET, 0.0),
    PARAM_FLOAT(FW_TECS_PITCH_F, 0.2),
    PARAM_FLOAT(FW_TECS_THOR_FF, 0.25),
    PARAM_FLOAT(FW_TECS_PITCH_P, 0.2),
    PARAM_FLOAT(FW_TECS_THOR_P, 0.75),
    PARAM_FLOAT(FW_TECS_PITCH_I, 0.15),
    PARAM_FLOAT(FW_TECS_PITCH_I_LIM, 0.3),
    PARAM_FLOAT(FW_TECS_THOR_I, 0.2),
    PARAM_FLOAT(FW_TECS_PITCH_D, 0.0),
    PARAM_FLOAT(FW_TECS_THOR_D, 0.0),
    PARAM_FLOAT(FW_TECS_VEL_P, 1.0),
    PARAM_FLOAT(FW_TECS_RATIO, 1.0),
    PARAM_FLOAT(FW_TECS_W2T, 1.0),
    PARAM_FLOAT(FW_TECS_U2T, 1.0),
    PARAM_FLOAT(FW_TECS_W2P, 1.5),
    PARAM_FLOAT(FW_TECS_U2P, 0.2),
    PARAM_FLOAT(FW_TECS_R2P, 0.0),
    PARAM_FLOAT(FW_TECS_R2T, 0.0),
    PARAM_UINT16(FW_OUT_MAX, 2000),
    PARAM_UINT16(FW_OUT_MIN, 1000),

    PARAM_FLOAT(FW_AILERON1_DIR, 1.0),
    PARAM_FLOAT(FW_AILERON2_DIR, 1.0),
    PARAM_FLOAT(FW_ELEVATOR_DIR, 1.0),
    PARAM_FLOAT(FW_RUDDER_DIR, 1.0),
    PARAM_FLOAT(FW_TAIL1_DIR, 1.0),
    PARAM_FLOAT(FW_TAIL2_DIR, 1.0),
    PARAM_FLOAT(SERVO1_BIAS, 0.0),
    PARAM_FLOAT(SERVO2_BIAS, 0.0),
    PARAM_FLOAT(SERVO3_BIAS, 0.0),
    PARAM_FLOAT(SERVO4_BIAS, 0.0),
};
