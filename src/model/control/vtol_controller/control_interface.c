...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(MC_ROLL_RATE_D, 0.006, false),
    PARAM_FLOAT(MC_PITCH_RATE_D, 0.009, false),
    ...
    PARAM_FLOAT(FW_PITCH_RATE_P, 0.15, false),
    ...
    PARAM_FLOAT(FW_RATE_I_MIN, -0.4, false),
