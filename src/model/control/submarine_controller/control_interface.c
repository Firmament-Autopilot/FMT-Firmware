...
static param_t __param_list[] = {
    PARAM_UINT8(AIRFRAME, AIRFRAME),
    PARAM_FLOAT(VEL_X_P, 1.4),
    PARAM_FLOAT(VEL_X_I, 0.2),
    PARAM_FLOAT(VEL_X_D, 0.2),
    PARAM_FLOAT(VEL_Z_P, 0.6),
    PARAM_FLOAT(VEL_Z_I, 0.1),
    PARAM_FLOAT(VEL_Z_D, 0.0),
    PARAM_FLOAT(VEL_X_I_MIN, -1),
    PARAM_FLOAT(VEL_X_I_MAX, 1),
    PARAM_FLOAT(VEL_X_D_MIN, -1),
    PARAM_FLOAT(VEL_X_D_MAX, 1),
    ...
    PARAM_FLOAT(PITCH_CMD_LIM, PI / 6),
    PARAM_FLOAT(PITCH_RATE_P, 0.3),
    PARAM_FLOAT(PITCH_RATE_I, 0.2),
    PARAM_FLOAT(PITCH_RATE_D, 0.003),
    PARAM_FLOAT(RATE_I_MIN, -0.2),
    PARAM_FLOAT(RATE_I_MAX, 0.2),
    PARAM_FLOAT(RATE_D_MIN, -0.1),
    PARAM_FLOAT(RATE_D_MAX, 0.1),
    PARAM_FLOAT(Q_CMD_LIM, PI / 2),
};
