...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(VEL_X_P, 1.4, false),
    PARAM_FLOAT(VEL_X_I, 0.2, false),
    PARAM_FLOAT(VEL_X_D, 0.2, false),
    PARAM_FLOAT(VEL_Z_P, 0.6, false),
    PARAM_FLOAT(VEL_Z_I, 0.1, false),
    PARAM_FLOAT(VEL_Z_D, 0.0, false),
    PARAM_FLOAT(VEL_X_I_MIN, -1, false),
    PARAM_FLOAT(VEL_X_I_MAX, 1, false),
    PARAM_FLOAT(VEL_X_D_MIN, -1, false),
    PARAM_FLOAT(VEL_X_D_MAX, 1, false),
    ...
    PARAM_FLOAT(PITCH_CMD_LIM, PI / 6, false),
    PARAM_FLOAT(PITCH_RATE_P, 0.3, false),
    PARAM_FLOAT(PITCH_RATE_I, 0.2, false),
    PARAM_FLOAT(PITCH_RATE_D, 0.003, false),
    PARAM_FLOAT(RATE_I_MIN, -0.2, false),
    PARAM_FLOAT(RATE_I_MAX, 0.2, false),
    PARAM_FLOAT(RATE_D_MIN, -0.1, false),
    PARAM_FLOAT(RATE_D_MAX, 0.1, false),
    PARAM_FLOAT(Q_CMD_LIM, PI / 2, false),
};
...
{
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, VEL_X_P), &CONTROL_PARAM.VEL_X_P));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, VEL_X_I), &CONTROL_PARAM.VEL_X_I));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, VEL_X_D), &CONTROL_PARAM.VEL_X_D));
    ...
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, VEL_X_I_MIN), &CONTROL_PARAM.VEL_X_I_MIN));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, VEL_X_I_MAX), &CONTROL_PARAM.VEL_X_I_MAX));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, VEL_X_D_MIN), &CONTROL_PARAM.VEL_X_D_MIN));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, VEL_X_D_MAX), &CONTROL_PARAM.VEL_X_D_MAX));
    ...
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, PITCH_CMD_LIM), &CONTROL_PARAM.PITCH_CMD_LIM));
    ...
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, Q_CMD_LIM), &CONTROL_PARAM.Q_CMD_LIM));
}
