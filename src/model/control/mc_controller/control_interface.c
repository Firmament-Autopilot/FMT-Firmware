...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(MC_PITCH_P, 7),
    PARAM_FLOAT(MC_ROLL_PITCH_LIM, PI / 6),
    PARAM_FLOAT(MC_ROLLRATE_P, 0.15),
    PARAM_FLOAT(MC_PITCHRATE_P, 0.15),
    PARAM_FLOAT(MC_YAWRATE_P, 0.3),
    PARAM_FLOAT(MC_ROLLRATE_I, 0.15),
    PARAM_FLOAT(MC_PITCHRATE_I, 0.15),
    PARAM_FLOAT(MC_YAWRATE_I, 0.3),
    PARAM_FLOAT(MC_ROLLRATE_D, 0.005),
    PARAM_FLOAT(MC_PITCHRATE_D, 0.005),
    PARAM_FLOAT(MC_YAWRATE_D, 0.002),
    PARAM_FLOAT(MC_ROLLRATE_FF, 0.03),
    PARAM_FLOAT(MC_PITCHRATE_FF, 0.03),
    PARAM_FLOAT(MC_YAWRATE_FF, 0.05),
    PARAM_FLOAT(MC_RATE_I_MIN, -0.2),
    PARAM_FLOAT(MC_RATE_I_MAX, 0.2),
    PARAM_FLOAT(MC_RATE_D_MIN, -0.2),
    PARAM_FLOAT(MC_RATE_D_MAX, 0.2),
    PARAM_FLOAT(MC_RATE_XY_LIM, PI / 2),
    PARAM_FLOAT(MC_RATE_Z_LIM, PI),
...
static void init_parameter(void)
{
    ...
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_ROLL_PITCH_LIM), &CONTROL_PARAM.MC_ROLL_PITCH_LIM));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_ROLLRATE_P), &CONTROL_PARAM.MC_ROLLRATE_P));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_PITCHRATE_P), &CONTROL_PARAM.MC_PITCHRATE_P));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_YAWRATE_P), &CONTROL_PARAM.MC_YAWRATE_P));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_ROLLRATE_I), &CONTROL_PARAM.MC_ROLLRATE_I));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_PITCHRATE_I), &CONTROL_PARAM.MC_PITCHRATE_I));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_YAWRATE_I), &CONTROL_PARAM.MC_YAWRATE_I));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_ROLLRATE_D), &CONTROL_PARAM.MC_ROLLRATE_D));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_PITCHRATE_D), &CONTROL_PARAM.MC_PITCHRATE_D));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_YAWRATE_D), &CONTROL_PARAM.MC_YAWRATE_D));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_ROLLRATE_FF), &CONTROL_PARAM.MC_ROLLRATE_FF));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_PITCHRATE_FF), &CONTROL_PARAM.MC_PITCHRATE_FF));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_YAWRATE_FF), &CONTROL_PARAM.MC_YAWRATE_FF));
    ...
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_RATE_XY_LIM), &CONTROL_PARAM.MC_RATE_XY_LIM));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, MC_RATE_Z_LIM), &CONTROL_PARAM.MC_RATE_Z_LIM));
