...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(MC_VEL_XY_D, 0.05, false),
    ...
    PARAM_FLOAT(MC_PITCH_P, 7, false),
    PARAM_FLOAT(MC_ROLL_PITCH_LIM, PI / 6, false),
    PARAM_FLOAT(MC_ROLLRATE_P, 0.15, false),
    PARAM_FLOAT(MC_PITCHRATE_P, 0.15, false),
    PARAM_FLOAT(MC_YAWRATE_P, 0.3, false),
    PARAM_FLOAT(MC_ROLLRATE_I, 0.15, false),
    PARAM_FLOAT(MC_PITCHRATE_I, 0.15, false),
    PARAM_FLOAT(MC_YAWRATE_I, 0.3, false),
    PARAM_FLOAT(MC_ROLLRATE_D, 0.005, false),
    PARAM_FLOAT(MC_PITCHRATE_D, 0.005, false),
    PARAM_FLOAT(MC_YAWRATE_D, 0.002, false),
    PARAM_FLOAT(MC_ROLLRATE_FF, 0.03, false),
    PARAM_FLOAT(MC_PITCHRATE_FF, 0.03, false),
    PARAM_FLOAT(MC_YAWRATE_FF, 0.05, false),
    ...
    PARAM_FLOAT(MC_RATE_XY_LIM, PI / 2, false),
    PARAM_FLOAT(MC_RATE_Z_LIM, PI, false),
