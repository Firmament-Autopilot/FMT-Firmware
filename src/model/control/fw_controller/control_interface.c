...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(FW_AIRSPEED_TRIM, 15),
    ...
    PARAM_FLOAT(FW_PITCH_OFFSET, 0 / 180.0f * PI),

    PARAM_FLOAT(FW_TECS_PITCH_F, 0.1),
    PARAM_FLOAT(FW_TECS_THOR_FF, 0.1),
    PARAM_FLOAT(FW_TECS_PITCH_P, 0.4),
    PARAM_FLOAT(FW_TECS_THOR_P, 0.1),
    PARAM_FLOAT(FW_TECS_PITCH_I, 0.2),
    PARAM_FLOAT(FW_TECS_PITCH_I_LIM, 0.2),
