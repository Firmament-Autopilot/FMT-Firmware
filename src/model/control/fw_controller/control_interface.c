...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(FW_TECS_SWITCH, 1),
    PARAM_FLOAT(FW_TECS_ANSW, 1),
    PARAM_FLOAT(FW_TECS_VERR_K, 1),
    PARAM_FLOAT(FW_TECS_ANG_K, 1),
    PARAM_FLOAT(FW_TECS_W2T, 1),
    PARAM_FLOAT(FW_TECS_U2T, 1),
    PARAM_FLOAT(FW_TECS_R2P, 0.2),
    PARAM_FLOAT(FW_TECS_R2T, 0.2),
};
