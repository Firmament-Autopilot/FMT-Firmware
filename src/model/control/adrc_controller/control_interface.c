...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(VEL_XY_D, 0.05),
    PARAM_FLOAT(VEL_Z_P, 0.5),
    PARAM_FLOAT(VEL_Z_I, 0.12),
    ...
    PARAM_FLOAT(VEL_Z_I_MIN, -0.2),
    PARAM_FLOAT(VEL_Z_I_MAX, 0.2),
    ...
    PARAM_FLOAT(ROLL_RATE_I, 0.05),
    PARAM_FLOAT(PITCH_RATE_I, 0.05),
    PARAM_FLOAT(YAW_RATE_I, 0.15),
    PARAM_FLOAT(ROLL_RATE_D, 0.0015),
    PARAM_FLOAT(PITCH_RATE_D, 0.0015),
    ...
    PARAM_FLOAT(LADRC_ROLL_B0, 300),
    PARAM_FLOAT(LADRC_PITCH_B0, 300),
    PARAM_FLOAT(LADRC_YAW_B0, 200),
    PARAM_FLOAT(LADRC_ROLL_BETA1, 500),
    PARAM_FLOAT(LADRC_PITCH_BETA1, 500),
    PARAM_FLOAT(LADRC_YAW_BETA1, 350),
    PARAM_FLOAT(LADRC_ROLL_BETA2, 1800),
    PARAM_FLOAT(LADRC_PITCH_BETA2, 1800),
    PARAM_FLOAT(LADRC_YAW_BETA2, 1400),
    PARAM_FLOAT(LADRC_ROLL_GAMMA, 0.5),
    PARAM_FLOAT(LADRC_PITCH_GAMMA, 0.5),
    PARAM_FLOAT(LADRC_YAW_GAMMA, 0.5),
    PARAM_FLOAT(LADRC_ROLL_Z2_LIM, 60),
    PARAM_FLOAT(LADRC_PITCH_Z2_LIM, 60),
    PARAM_FLOAT(LADRC_YAW_Z2_LIM, 100),
};
