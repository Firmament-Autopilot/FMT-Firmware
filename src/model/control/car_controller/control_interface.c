...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(VEL_P, 0.25),
    PARAM_FLOAT(VEL_I, 0.5),
    PARAM_FLOAT(VEL_D, 0.0),
    PARAM_FLOAT(VEL_I_MAX, 0.5),
    PARAM_FLOAT(VEL_I_MIN, -0.5),
    PARAM_FLOAT(VEL_D_MAX, 0.1),
    PARAM_FLOAT(VEL_D_MIN, -0.1),
    PARAM_FLOAT(R_FF, 0.5),
    PARAM_FLOAT(R_P, 0.05),
    PARAM_FLOAT(R_I, 0.25),
    PARAM_FLOAT(R_D, 0.0),
    PARAM_FLOAT(R_I_MAX, 0.3),
    PARAM_FLOAT(R_I_MIN, -0.3),
    PARAM_FLOAT(R_D_MAX, 0.1),
    PARAM_FLOAT(R_D_MIN, -0.1),
    PARAM_FLOAT(THROTTLE_SCALE, 500.0),
    PARAM_UINT16(THROTTLE_BIAS, 1500),
    PARAM_FLOAT(SERVO_SCALE, 500.0),
...
static void init_parameter(void)
{
    ...
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, R_FF), &CONTROL_PARAM.R_FF));
