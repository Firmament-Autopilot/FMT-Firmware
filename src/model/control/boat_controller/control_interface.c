...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(VEL_P, 0.5),
    PARAM_FLOAT(VEL_I, 0.1),
    PARAM_FLOAT(VEL_D, 0.0),
    PARAM_FLOAT(VEL_I_MAX, 0.8),
    PARAM_FLOAT(VEL_I_MIN, -0.8),
    PARAM_FLOAT(VEL_D_MAX, 0.1),
    PARAM_FLOAT(VEL_D_MIN, -0.1),
    PARAM_FLOAT(FW_PSI_RATE_P, 0.0),
    PARAM_FLOAT(FW_PSI_RATE_I, 0.2),
    PARAM_FLOAT(FW_PSI_RATE_D, 0.0),
    PARAM_FLOAT(FW_PSI_RATE_FF, 2.0),
    PARAM_FLOAT(BW_PSI_RATE_P, 2.0),
    PARAM_FLOAT(BW_PSI_RATE_I, 0.2),
    PARAM_FLOAT(BW_PSI_RATE_D, 0.05),
    PARAM_FLOAT(BW_PSI_RATE_FF, 0.0),
    PARAM_FLOAT(THROTTLE_SCALE, 400),
    PARAM_FLOAT(THROTTLE2_SCALE, 400),
    PARAM_UINT16(THROTTLE_BIAS, 1500),
    PARAM_UINT16(THROTTLE2_BIAS, 1500),
    PARAM_FLOAT(SERVO_SCALE, 250),
    PARAM_UINT16(SERVO_BIAS, 1500),
    PARAM_FLOAT(THROTTLE_MAX, 1.0),
    PARAM_FLOAT(THROTTLE_MIN, -1.0),
    PARAM_FLOAT(SERVO_MAX, 1.0),
    PARAM_FLOAT(SERVO_MIN, -1.0),
};
