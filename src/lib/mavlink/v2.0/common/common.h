...
typedef enum MAV_AUTOPILOT {
    ...
    MAV_AUTOPILOT_FMT = 20,                                         /*Firmament autopilot */
...
// MAVLINK VERSION
    ...
    #include "./mavlink_msg_param_v3_ack.h"
    #include "./mavlink_msg_param_v3_set.h"
    #include "./mavlink_msg_param_v3_value.h"
