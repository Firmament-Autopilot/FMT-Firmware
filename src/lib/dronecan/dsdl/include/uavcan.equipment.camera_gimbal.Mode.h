...
static inline void _uavcan_equipment_camera_gimbal_Mode_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_equipment_camera_gimbal_Mode* msg, bool tao);
...
void _uavcan_equipment_camera_gimbal_Mode_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_equipment_camera_gimbal_Mode* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
