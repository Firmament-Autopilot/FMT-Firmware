...
class uavcan_equipment_hardpoint_Status_cxx_iface;
#endif

struct uavcan_equipment_hardpoint_Status {
#if defined(__cplusplus) && defined(DRONECAN_CXX_WRAPPERS)
    using cxx_iface = uavcan_equipment_hardpoint_Status_cxx_iface;
#endif
...
BROADCAST_MESSAGE_CXX_IFACE(uavcan_equipment_hardpoint_Status, UAVCAN_EQUIPMENT_HARDPOINT_STATUS_ID, UAVCAN_EQUIPMENT_HARDPOINT_STATUS_SIGNATURE, UAVCAN_EQUIPMENT_HARDPOINT_STATUS_MAX_SIZE);
#endif
#endif
