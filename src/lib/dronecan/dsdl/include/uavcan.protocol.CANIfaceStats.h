...
static inline void _uavcan_protocol_CANIfaceStats_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_CANIfaceStats* msg, bool tao);
...
void _uavcan_protocol_CANIfaceStats_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_CANIfaceStats* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
