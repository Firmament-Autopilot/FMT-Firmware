...
static inline void _uavcan_protocol_file_GetDirectoryEntryInfoResponse_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_file_GetDirectoryEntryInfoResponse* msg, bool tao);
...
void _uavcan_protocol_file_GetDirectoryEntryInfoResponse_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_file_GetDirectoryEntryInfoResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    ...
    _uavcan_protocol_file_EntryType_decode(transfer, bit_ofs, &msg->entry_type, false);

    _uavcan_protocol_file_Path_decode(transfer, bit_ofs, &msg->entry_full_path, tao);
