...
static inline void _uavcan_CoarseOrientation_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_CoarseOrientation* msg, bool tao);
...
void _uavcan_CoarseOrientation_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_CoarseOrientation* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
