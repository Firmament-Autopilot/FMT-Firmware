...
static mav_param_list_t mavlink_param = {
    MAVLINK_PARAM_DEFINE(SYS_AUTOSTART, 4001, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(SYS_AUTOCONFIG, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(SYS_PARAM_VER, 0.2, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(MAV_SYS_ID, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(MAV_COMP_ID, 0, MAV_PARAM_TYPE_REAL32),
#ifdef FMT_USING_MAVLINK_V2
    MAVLINK_PARAM_DEFINE(MAV_PROTO_VER, 2, MAV_PARAM_TYPE_REAL32), /* Mavlink Version */
#else
    MAVLINK_PARAM_DEFINE(MAV_PROTO_VER, 1, MAV_PARAM_TYPE_REAL32), /* Mavlink Version */
#endif
    MAVLINK_PARAM_DEFINE(MAV_RADIO_ID, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(MAV_TYPE, MAV_TYPE_QUADROTOR, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(MAV_USEHILGPS, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(MAV_FWDEXTSP, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(MAV_BROADCAST, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_BOARD_ID, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_GYRO0_ID, 125, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(CAL_MAG0_ID, 130, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_MAG1_ID, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_MAG2_ID, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_MAG0_ROT, ROTATION_NONE, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_MAG1_ROT, ROTATION_NONE, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_MAG2_ROT, ROTATION_NONE, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(CAL_ACC0_ID, 120, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(CAL_ACC_PRIME, 125, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_GYRO_PRIME, 120, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_MAG_PRIME, 130, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(CAL_MAG_SIDES, 63, MAV_PARAM_TYPE_REAL32), /* 6 side calibration */
    MAVLINK_PARAM_DEFINE(CAL_BARO_PRIME, 0, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(SENS_BOARD_ROT, ROTATION_NONE, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(SENS_FLOW_ROT, ROTATION_NONE, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(SENS_EXT_MAG_ROT, ROTATION_NONE, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(SENS_EXT_MAG, ROTATION_NONE, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(RC_MAP_ROLL, 1, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_PITCH, 2, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_YAW, 4, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_THROTTLE, 3, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_FAILSAFE, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_MODE_SW, 5, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_RETURN_SW, 7, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_FLAPS, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_RATT_SW, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_POSCTL_SW, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_LOITER_SW, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_ACRO_SW, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_OFFB_SW, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_KILL_SW, 9, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_AUX1, 5, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_AUX2, 6, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_AUX3, 7, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_AUX4, 8, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_AUX5, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_PARAM1, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_PARAM2, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_PARAM3, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_MAP_FLTMODE, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_FAILS_THR, 0, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(RC_CHAN_CNT, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(RC_TH_USER, 1, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_DL_LOSS_T, 10, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_DL_REG_T, 0, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(COM_RC_IN_MODE, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_RC_ARM_HYST, 1000, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_DISARM_LAND, 2, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_LOW_BAT_ACT, 1, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(NAV_DLL_ACT, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(NAV_RCL_ACT, 2, MAV_PARAM_TYPE_REAL32),
    ...
    MAVLINK_PARAM_DEFINE(COM_FLTMODE1, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_FLTMODE2, 1, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_FLTMODE3, 2, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_FLTMODE4, 3, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_FLTMODE5, 4, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(COM_FLTMODE6, 5, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(GF_ACTION, 1, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(GF_ALTMODE, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(GF_SOURCE, 0, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(GF_COUNT, -1, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(GF_MAX_HOR_DIST, -1, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(GF_MAX_VER_DIST, -1, MAV_PARAM_TYPE_REAL32),
    MAVLINK_PARAM_DEFINE(GF_FENCE_SW, 1, MAV_PARAM_TYPE_REAL32),
