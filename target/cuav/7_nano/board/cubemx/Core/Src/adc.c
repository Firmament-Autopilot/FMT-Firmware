...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  LL_GPIO_Init(RSSI_IN_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = SCALED1_V3V3_Pin|SCALED2_V3V3_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = FMU_SERVORAIL_VCC_SENS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(FMU_SERVORAIL_VCC_SENS_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = VDD_5V_SENS_Pin|BATT_CURRENT_SENS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
void MX_ADC3_Init(void)
{
  ...
  PC3_C   ------> ADC3_INP1
  */
  GPIO_InitStruct.Pin = ADC3_6V6_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ADC3_6V6_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = BATT_VOLTAGE_SENS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(BATT_VOLTAGE_SENS_GPIO_Port, &GPIO_InitStruct);
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC3, LL_ADC_CHANNEL_5, LL_ADC_SAMPLINGTIME_1CYCLE_5);
