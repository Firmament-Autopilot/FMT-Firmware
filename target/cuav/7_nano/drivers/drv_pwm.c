...
rt_inline void __write_pwm(uint8_t chan_id, float dc)
{
    switch (chan_id) {
    case 0:
        LL_TIM_OC_SetCompareCH4(TIM5, PWM_ARR(__pwm_freq) * dc);
        break;
    case 1:
        LL_TIM_OC_SetCompareCH3(TIM5, PWM_ARR(__pwm_freq) * dc);
        break;
    case 2:
    ...
    case 8:
        ...
        break;
    case 9:
        LL_TIM_OC_SetCompareCH3(TIM8, PWM_ARR(__pwm_freq) * dc);
        break;
    case 10:
        LL_TIM_OC_SetCompareCH1(TIM8, PWM_ARR(__pwm_freq) * dc);
        break;
    case 11:
        LL_TIM_OC_SetCompareCH2(TIM15, PWM_ARR(__pwm_freq) * dc);
        break;
    case 12:
...
rt_err_t __set_pwm_frequency(uint16_t freq)
{
    ...
    LL_TIM_SetAutoReload(TIM8, PWM_ARR(__pwm_freq) - 1);
    LL_TIM_SetAutoReload(TIM12, PWM_ARR(__pwm_freq) - 1);
    LL_TIM_SetAutoReload(TIM15, PWM_ARR(__pwm_freq) - 1);
