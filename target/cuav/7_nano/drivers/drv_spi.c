...
rt_err_t drv_spi_init(void)
{
    ...
    /* attach spi1_device_1 (IIM42652) to spi1 */
    {
        static struct rt_spi_device rt_spi1_device_1;
        static struct stm32_spi_cs stm32_spi1_cs_1;
        LL_GPIO_InitTypeDef GPIO_InitStruct = { 0 };

        stm32_spi1_cs_1.GPIOx = GPIOI;
        stm32_spi1_cs_1.GPIO_Pin = LL_GPIO_PIN_9;
    ...
    /* attach spi2_device_1 (BMI088-G), spi2_device_2 (BMI088-A) */
    {
        static struct rt_spi_device rt_spi2_device_1, rt_spi2_device_2;
        static struct stm32_spi_cs stm32_spi2_cs_1, stm32_spi2_cs_2;
        LL_GPIO_InitTypeDef GPIO_InitStruct = { 0 };

        stm32_spi2_cs_1.GPIOx = GPIOG;
        stm32_spi2_cs_1.GPIO_Pin = LL_GPIO_PIN_2;

        stm32_spi2_cs_2.GPIOx = GPIOH;
        stm32_spi2_cs_2.GPIO_Pin = LL_GPIO_PIN_5;
        ...
        GPIO_InitStruct.Pull = LL_GPIO_PULL_UP;
        LL_GPIO_Init(GPIOH, &GPIO_InitStruct);
        LL_GPIO_SetOutputPin(GPIOH, LL_GPIO_PIN_5);
    ...
    /* attach spi5_device_1 (RAMTRON) to spi5 */
    {
        static struct rt_spi_device rt_spi5_device_1;
        static struct stm32_spi_cs stm32_spi5_cs_1;
        LL_GPIO_InitTypeDef GPIO_InitStruct = { 0 };

        stm32_spi5_cs_1.GPIOx = GPIOG;
        stm32_spi5_cs_1.GPIO_Pin = LL_GPIO_PIN_7;
