...
static rt_err_t adc1_hw_init(void)
{
    ...
    */
    ...
    ADC1->PCSEL |= (1UL << __LL_ADC_CHANNEL_TO_DECIMAL_NB(LL_ADC_CHANNEL_16))
        | (1UL << __LL_ADC_CHANNEL_TO_DECIMAL_NB(LL_ADC_CHANNEL_17));
...
rt_err_t drv_adc_init(void)
{
    ...
    RT_TRY(hal_adc_register(&adc0, "adc0", RT_DEVICE_FLAG_RDONLY, &stm_adc1));
