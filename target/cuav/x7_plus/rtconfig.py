...
if PLATFORM == 'gcc':
    ...
    DEFINES = ' -DUSE_FULL_LL_DRIVER -DUSE_HAL_DRIVER -DSTM32H743xx -D__VFP_FP__ -DARM_MATH_MATRIX_CHECK -DARM_MATH_CM7 -DARM_MATH_ROUNDING -DHSE_VALUE="16000000" -DUSER_VECT_TAB_ADDRESS'
    CFLAGS = DEVICE + \
