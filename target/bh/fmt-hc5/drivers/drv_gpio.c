...
static void hc32_pin_write(pin_dev_t dev, rt_base_t pin, rt_base_t value)
{
    uint8_t gpio_port;
    uint16_t gpio_pin;
...
static int hc32_pin_read(pin_dev_t dev, rt_base_t pin)
{
    uint8_t gpio_port;
    uint16_t gpio_pin;
    int value = PIN_LOW;
...
static void hc32_pin_mode(pin_dev_t dev, rt_base_t pin, rt_base_t mode, rt_base_t otype)
{
