...
#define CONFIG_USBD_VID           0x1209
#define CONFIG_USBD_PID           0x2119

/* Support old RT-Thread version */
#ifndef RT_VERSION_CHECK
#define RT_VERSION_CHECK(major, minor, revise)  ((major * 10000) + (minor * 100) + revise)
#endif

#define USB_OTG_FS_BASE_ADDR 0x40080000
// #define CONFIG_DWC2_VBUS_SENSING

/* ================ USB common Configuration ================ */

#define CONFIG_USB_PRINTF(...) console_printf(__VA_ARGS__)
...
#define CONFIG_USBDEV_MTP_PRIO 18
#endif
...
#ifndef CONFIG_USBDEV_MTP_ROOT_PATH
#define CONFIG_USBDEV_MTP_ROOT_PATH "/"
#endif
