...
static void pwm_timer_init(void)
{
    ...
    GPIO_SetFunc(GPIO_PORT_E, GPIO_PIN_09, GPIO_FUNC_4); // TIMA-1-PWM1/TIMA-1-CLKA
    GPIO_SetFunc(GPIO_PORT_E, GPIO_PIN_11, GPIO_FUNC_4); // TIMA-1-PWM2/TIMA-1-CLKB
    GPIO_SetFunc(GPIO_PORT_E, GPIO_PIN_13, GPIO_FUNC_4); // TIMA-1-PWM3
    GPIO_SetFunc(GPIO_PORT_E, GPIO_PIN_14, GPIO_FUNC_4); // TIMA-1-PWM4
    ...
    GPIO_SetFunc(GPIO_PORT_B, GPIO_PIN_00, GPIO_FUNC_5); // TIMA-3-PWM3
    GPIO_SetFunc(GPIO_PORT_B, GPIO_PIN_01, GPIO_FUNC_5); // TIMA-3-PWM4
    (void)TMRA_PWM_Init(CM_TMRA_3, TMRA_CH1, &stcPwmInit);
    (void)TMRA_PWM_Init(CM_TMRA_3, TMRA_CH2, &stcPwmInit);
    (void)TMRA_PWM_Init(CM_TMRA_3, TMRA_CH3, &stcPwmInit);
    (void)TMRA_PWM_Init(CM_TMRA_3, TMRA_CH4, &stcPwmInit);
    TMRA_PWM_OutputCmd(CM_TMRA_3, TMRA_CH1, ENABLE);
    TMRA_PWM_OutputCmd(CM_TMRA_3, TMRA_CH2, ENABLE);
    TMRA_PWM_OutputCmd(CM_TMRA_3, TMRA_CH3, ENABLE);
    TMRA_PWM_OutputCmd(CM_TMRA_3, TMRA_CH4, ENABLE);

    GPIO_SetFunc(GPIO_PORT_D, GPIO_PIN_12, GPIO_FUNC_4); // TIMA-4-PWM1/TIMA-4-CLKA
    GPIO_SetFunc(GPIO_PORT_D, GPIO_PIN_13, GPIO_FUNC_4); // TIMA-4-PWM2/TIMA-4-CLKB
    GPIO_SetFunc(GPIO_PORT_D, GPIO_PIN_14, GPIO_FUNC_4); // TIMA-4-PWM3
    GPIO_SetFunc(GPIO_PORT_D, GPIO_PIN_15, GPIO_FUNC_4); // TIMA-4-PWM4
...
rt_inline void __write_pwm(uint8_t chan_id, float dc)
{
    ...
    case 11:
        ...
        break;
    case 12:
        TMRA_SetCompareValue(CM_TMRA_3, TMRA_CH1, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    case 13:
        TMRA_SetCompareValue(CM_TMRA_3, TMRA_CH2, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    case 14:
        TMRA_SetCompareValue(CM_TMRA_3, TMRA_CH3, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    case 15:
        TMRA_SetCompareValue(CM_TMRA_3, TMRA_CH4, PWM_ARR(__pwm_freq) * dc - 1);
        break;
    default:
        return;
    }
...
static rt_err_t __set_pwm_frequency(uint16_t freq)
{
    ...
    TMRA_SetPeriodValue(CM_TMRA_3, PWM_ARR(__pwm_freq) - 1);
