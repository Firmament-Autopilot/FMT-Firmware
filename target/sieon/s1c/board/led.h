...
#define __WL32_PORT(port)     GPIO_PORT_##port
#define GET_PIN(PORTx, PIN)   (rt_base_t)((16 * __WL32_PORT(PORTx)) + PIN)

#define FMU_RGB_LED_RED_PIN   GET_PIN(D, 6)
#define FMU_RGB_LED_GREEN_PIN GET_PIN(D, 5)
#define FMU_RGB_LED_BLUE_PIN  GET_PIN(D, 4)
