...
static void USART6_TX_DMA_TC_IrqCallback(void);
static void USART6_TxComplete_IrqCallback(void);

static struct serial_device serial1;
static struct wl32_uart uart6 = {
    .uart_periph = CM_USART6,
    .rx_err_irq = USART6_RX_ERR_IRQn,
    .rx_err_int_src = INT_SRC_USART6_EI,
    .rx_err_callback = &USART6_RxError_IrqCallback,
    .rx_full_irq = USART6_RX_FULL_IRQn,
    .rx_full_int_src = INT_SRC_USART6_RI,
    .rx_full_callback = &USART6_RxFull_IrqCallback,
    .dma = {
        // .dma_rx_ch = DMA_CH0,
        ...
        .dma_periph = USART6_TX_DMA_UNIT,
        .dma_tx_ch = USART6_TX_DMA_CH,
        .dma_tx_tc_irq = USART6_TX_DMA_TC_IRQn,
        .dma_tx_tc_int_src = USART6_TX_DMA_TC_INT_SRC,
        .dma_tx_tc_callback = &USART6_TX_DMA_TC_IrqCallback,
        .dma_tx_tc_flag = USART6_TX_DMA_TC_FLAG,
        .dma_tx_trig_sel = USART6_TX_DMA_TRIG_SEL,
        .dma_tx_trig_evt_src = USART6_TX_DMA_TRIG_EVT_SRC,
        .dma_tx_tc_int = USART6_TX_DMA_TC_INT,
        .tx_cplt_irq = USART6_TX_CPLT_IRQn,
        .tx_cplt_int_src = INT_SRC_USART6_TCI,
        .tx_cplt_callback = &USART6_TxComplete_IrqCallback,
    }
};
...
{
    rt_interrupt_enter();
    (void)USART_ReadData(uart6.uart_periph);
    USART_ClearStatus(uart6.uart_periph, (USART_FLAG_PARITY_ERR | USART_FLAG_FRAME_ERR | USART_FLAG_OVERRUN));
    rt_interrupt_leave();
}
...
{
    rt_interrupt_enter();
    USART_FuncCmd(uart6.uart_periph, USART_INT_TX_CPLT, ENABLE);
    DMA_ClearTransCompleteStatus(uart6.dma.dma_periph, uart6.dma.dma_tx_tc_flag);
    rt_interrupt_leave();
}
...
{
    rt_interrupt_enter();
    USART_FuncCmd(uart6.uart_periph, (USART_TX | USART_INT_TX_CPLT), DISABLE);
...
static void dma_tx_config(struct wl32_uart* uart)
{
    int32_t i32Ret;
...
static void dma_rx_config(struct wl32_uart* uart, rt_uint8_t* buf, rt_size_t size)
{
    // int32_t i32Ret;
    // stc_dma_init_t stcDmaInit;
