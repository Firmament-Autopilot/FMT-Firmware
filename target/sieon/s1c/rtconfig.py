...
if PLATFORM == 'gcc':
    ...
    CFLAGS = DEVICE + ' -g -Wall -Wstrict-aliasing=0 -Wno-uninitialized -Wno-unused-function -Wno-switch -DUSE_STDPERIPH_DRIVER -DWL32F436 -D__VFP_FP__ -DARM_MATH_CM4 -D__FPU_PRESENT="1" -D__FPU_USED="1"'
