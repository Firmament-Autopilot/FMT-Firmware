param (
    ...
    [string]$toolchain_dir = "D:\ProgramFiles\RT-ThreadStudio\repo\Extract\ToolChain_Support_Packages\ARM\GNU_Tools_for_ARM_Embedded_Processors\13.3",

    [string]$elf_file = "$scriptDir/../m33/rt-thread.elf"
)
...
# 反汇编
& $arm_objdump -d -S $elf_file > "$scriptDir/../m33/rt-thread.asm"

# 启动 GDB
& $arm_gdb -x m33_gdb_script.gdb $elf_file
