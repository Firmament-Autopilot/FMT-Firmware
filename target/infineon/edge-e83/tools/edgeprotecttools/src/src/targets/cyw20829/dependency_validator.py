...
"""
from ..common.mxs40sv2.dependencies_validator import (
    ...
    RevocationAndEncryptionValidator, OemSecureKeyValidator
)
from ..common.mxs40sv2 import DependencyValidatorMXS40Sv2


class DependencyValidator(DependencyValidatorMXS40Sv2):
