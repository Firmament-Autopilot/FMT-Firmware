...
/**
 * \addtogroup group_mtb_srf_config Secure Request Framework Configuration
 * \{
 ...
 * modules - one for the Periphal Driver Library (PDL) and one for the user.
 *
