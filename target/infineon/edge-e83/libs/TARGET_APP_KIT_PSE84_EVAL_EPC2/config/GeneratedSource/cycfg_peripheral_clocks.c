...
void init_cycfg_peripheral_clocks(void)
{
    ...
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)CYBSP_UART1_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 0U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_UART1_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 0U, 86U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)CYBSP_UART1_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 0U);
    ...
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)CYBSP_UART2_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 3U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_UART2_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 3U, 86U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)CYBSP_UART2_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 3U);
    ...
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)CYBSP_UART4_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 1U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_UART4_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 1U, 86U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)CYBSP_UART4_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 1U);
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)CYBSP_UART9_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 2U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_UART9_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 2U, 86U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)CYBSP_UART9_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 2U);
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)CYBSP_UART10_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 3U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_UART10_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 3U, 86U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)CYBSP_UART10_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 3U);
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)CYBSP_UART11_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_5_BIT, 0U);
    Cy_SysClk_PeriPclkSetFracDivider((en_clk_dst_t)CYBSP_UART11_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_5_BIT, 0U, 85U, 26U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)CYBSP_UART11_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_5_BIT, 0U);
    ...
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_0_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 0U);
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_1_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 1U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_1_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 1U, 0U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_1_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 1U);
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_2_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 2U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_2_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 2U, 0U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_2_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 2U);
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_3_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 3U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_3_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 3U, 0U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)PERI_0_GROUP_2_DIV_8_3_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 3U);
