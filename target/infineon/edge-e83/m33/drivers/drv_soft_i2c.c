...
static struct ifx_soft_i2c i2c_obj[sizeof(soft_i2c_config) / sizeof(soft_i2c_config[0])];
 ...
 */
static void ifx_i2c_gpio_init(struct ifx_soft_i2c *i2c)
{
...
//{
//    rt_size_t obj_num = sizeof(i2c_obj) / sizeof(struct ifx_soft_i2c);
//
