...
// IFX_PATCH
// Forward declaration / fall back implementations of 
// INT-only registration functions (for low-memory footprint resolvers)
// These used to be included via the reference operator headers but requiring these to be
// include results in an extremely bloated header footprint for applications
// (headers from internal implementaiton libraries like gemmlowp need to be include)

// ****
// From tensorflow/lite/micro/kernels/add.h
// ****
...
// ****
// From tensorflow/lite/micro/kernels/conv.h
// ****
...
// ****
// from tensorflow/lite/micro/kernels/depthwise_conv.h
// ****
...
// ****
// From tensorflow/lite/micro/kernels/fully_connected.h
// ****
...
#if defined(MURISCV_NN) ||defined(CMSIS_NN)
// Returns a TFLMRegistration struct for kernel variant that only supports
// int16.
...
// ****
// From tensorflow/lite/micro/kernels/pooling.h
// ****


#if defined(MURISCV_NN) ||defined(CMSIS_NN) || defined(XTENSA)
...
// ****
// From tensorflow/lite/micro/kernels/softmax.h
// ****
