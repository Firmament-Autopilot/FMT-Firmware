...
class MicroAllocator {
 public:
  ...
  // Returns the amount of memory in bytes used for temp
  // buffers during allocations
  size_t used_temp() const;
 ...
 private:
  ...
  // Max used memory in bytes for temp buffers during allocations.
  size_t temp_used_bytes_ = 0;
