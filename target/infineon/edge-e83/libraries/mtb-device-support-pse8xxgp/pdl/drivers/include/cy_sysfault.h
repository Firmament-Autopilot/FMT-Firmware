...
* This is a centralized fault report structure. The centralized nature allows for a
...
* parameter (FAULT_NR). There are two instances of fault structures, each fault
