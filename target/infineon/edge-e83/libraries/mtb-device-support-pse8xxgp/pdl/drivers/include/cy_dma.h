...
* When D-Cache is present and enabled, this data pointer needs to point to 32 bit aligned data.
*
* \funcusage
...
* When D-Cache is present and enabled, this data pointer needs to point to 32 byte aligned data.
*
* \funcusage
* \snippet dma/snippet/main.c snippet_Cy_DMA_Descriptor_SetterFunctions
*
...
* When D-Cache is present and enabled this pointer needs to point to 32 byte aligned structure.
*
* \funcusage
* \snippet dma/snippet/main.c snippet_Cy_DMA_Enable
*
