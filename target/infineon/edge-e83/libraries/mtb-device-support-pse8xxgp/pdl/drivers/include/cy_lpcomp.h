...
* The individual comparator interrupt is masked by the INTR_MASK register.
* The masked result is captured in the INTR_MASKED register.
...
typedef enum
{
    ...
    CY_LPCOMP_MODE_ULP     = 1u,  /**< The low-power comparator channel ULP mode.
                                       \note A locally generated Ibias is used,
                                             refer to \ref Cy_LPComp_UlpReferenceEnable().*/
...
*
* \note The Ibias current is an alternative to the reference current generated by the SRSS.
*       Use Ibias current for the comparator in ULP mode, refer to \ref cy_en_lpcomp_pwr_t.
*
* \param *base
*     The low-power comparator register structure pointer.
*
...
__STATIC_INLINE void Cy_LPComp_SetInterruptMask(LPCOMP_Type* base, uint32_t interrupt)
{
    ...
    LPCOMP_INTR_MASK(base) = interrupt & CY_LPCOMP_INTR_Msk;
}
...
{
    CY_ASSERT_L2(CY_LPCOMP_IS_INTR_VALID(interrupt));
    LPCOMP_INTR(base) = interrupt & CY_LPCOMP_INTR_Msk;
