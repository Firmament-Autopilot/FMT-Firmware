...
* from the single cycle memory. Devices with CM7, CM33, or CM55 processor have I-Cache which
...
*
* \note While using for devices with a CM7 CPU, where the CPU supports branch prediction,
...
*
* \note
* This API is available for CM55 core devices.
*
*******************************************************************************/
