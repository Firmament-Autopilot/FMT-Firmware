...
typedef struct cy_stc_tcpwm_counter_config
{
    ...
    /** Sets the clock prescaler inside the TCPWM block. See \ref group_tcpwm_counter_clk_prescalers */
...
#if (CY_IP_MXTCPWM_VERSION >= 3U) || defined (CY_DOXYGEN)
#define CY_TCPWM_COUNTER_STATUS_CC0_READ_MISS   (0x4UL)        /**< Timer/Counter is miss reading the last capture0 event */
#define CY_TCPWM_COUNTER_STATUS_CC1_READ_MISS   (0x8UL)        /**< Timer/Counter is miss reading the last capture1 event */
#define CY_TCPWM_COUNTER_STATUS_KILL            (0x10UL)       /**< Timer/Counter has active kill event */
#endif /* (CY_IP_MXTCPWM_VERSION >= 2U) || defined (CY_DOXYGEN) */
#define CY_TCPWM_COUNTER_STATUS_COUNTER_RUNNING (0x80000000UL) /**< Timer/Counter is running */
