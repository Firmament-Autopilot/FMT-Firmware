...
* When D-Cache is enabled parameters key must align and end in 32 byte boundary.
*
*
* \param base
...
* When D-Cache is enabled parameters src & dst must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
...
* When D-Cache is enabled parameters iv must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
...
* When D-Cache is enabled parameters src must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
...
*
* Performs an AES CBC finish operation.
* When D-Cache is enabled parameters mac must align and end in 32 byte boundary.
*
*
* \param base
* The pointer to the CRYPTO instance.
...
* When D-Cache is enabled parameters aeskey must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
...
* When D-Cache is enabled parameters aad must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
...
* When D-Cache is enabled parameters input & output must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
...
* When D-Cache is enabled parameters p_tag must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
