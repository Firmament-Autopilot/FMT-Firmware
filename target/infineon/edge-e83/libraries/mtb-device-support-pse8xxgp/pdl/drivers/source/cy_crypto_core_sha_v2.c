...
*
* When D-Cache is enabled parameter digest must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
...
*
* When D-Cache is enabled parameter hashState must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
                                ...
                                cy_en_crypto_sha_mode_t mode)
{
    ...
    cy_stc_crypto_v2_sha_buffers_t *shaBuffers = (cy_stc_crypto_v2_sha_buffers_t *)CY_CRYPTO_DCACHE_ALIGN_ADDRESS(shaBuffers_t);
    cy_stc_crypto_sha_state_t *hashState = (cy_stc_crypto_sha_state_t *)CY_CRYPTO_DCACHE_ALIGN_ADDRESS(hashState_t);
