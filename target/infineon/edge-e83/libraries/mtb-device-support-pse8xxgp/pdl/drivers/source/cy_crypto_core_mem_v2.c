...
*
* When D-Cache is enabled parameter dst must align and end in 32 byte boundary.
*
*
* \param base
* The pointer to the CRYPTO instance.
...
*
*
* When D-Cache is enabled parameters src0 and src1 must align and end in 32 byte boundary.
*
* \param base
* The pointer to the CRYPTO instance.
*
...
* Memory structures should not overlap!
*
* When D-Cache is enabled parameters dst, src0 and src1 must align and end in 32 byte boundary.
*
*
* \param base
* The pointer to the CRYPTO instance.
