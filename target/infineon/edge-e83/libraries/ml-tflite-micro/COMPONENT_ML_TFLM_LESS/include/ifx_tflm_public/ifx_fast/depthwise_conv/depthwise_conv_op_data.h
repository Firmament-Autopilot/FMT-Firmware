...
#ifndef IFX_TFLM_PUBLIC_IFX_FAST_DEPTHWISE_CONV_OP_DATA_H_
#define IFX_TFLM_PUBLIC_IFX_FAST_DEPTHWISE_CONV_OP_DATA_H_
...
template <typename EVAL_INT8_PADDING_TRAIT>
class EvalInt8Padding {
 public:
...
template <typename CONTAINER_T, size_t bits_per_item,
            size_t items_per_container>
class PackedWithoutPaddingInt8 {
 public:
  static EVAL_FUNC_DECL(Run);
};
...
#endif // IFX_TFLM_PUBLIC_IFX_FAST_DEPTHWISE_CONV_OP_DATA_H_
