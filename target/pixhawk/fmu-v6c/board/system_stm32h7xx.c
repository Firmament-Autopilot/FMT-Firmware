...
#define VECT_TAB_BASE_ADDRESS   FLASH_BANK1_BASE  /*!< Vector Table base address field.
                                                       This value must be a multiple of 0x400. */
#define VECT_TAB_OFFSET         0x00020000U       /*!< Vector Table base offset field (128KB for bootloader).
                                                       This value must be a multiple of 0x400. */
#endif /* VECT_TAB_SRAM */
...
void SystemInit (void)
{
 ...
 __IO uint32_t tmpreg;
  ...
  /* FPU settings ------------------------------------------------------------*/
    ...
    /* Ensure FPCCR ASPEN and LSPEN are set at startup
       This sets bits 31 and 30 (0xC0000000) in FPCCR. */
