...
void FMS_step(void)
{
  ...
  switch (FMS_DW.SwitchCase_ActiveSubsystem) {
   case 0:
     ...
     */
    rtb_Compare_ko = (rtb_state_e == 2.0);
     ...
     */
    rtb_Compare_oi = (rtb_state_e == 2.0);
