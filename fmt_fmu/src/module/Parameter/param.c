...
PARAM_DECLARE_GROUP(CONTROL) = {
    ...
    PARAM_DEFINE_FLOAT(VEL_Z_P, 0.9),
    PARAM_DEFINE_FLOAT(VEL_Z_I, 0.1),
    PARAM_DEFINE_FLOAT(VEL_Z_D, 0.02),
    ...
    PARAM_DEFINE_FLOAT(ROLL_RATE_I, 0.075),
    PARAM_DEFINE_FLOAT(PITCH_RATE_I, 0.075),
    PARAM_DEFINE_FLOAT(YAW_RATE_I, 0.075),
    PARAM_DEFINE_FLOAT(ROLL_RATE_D, 0.004),
    PARAM_DEFINE_FLOAT(PITCH_RATE_D, 0.004),
